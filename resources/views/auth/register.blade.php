                        ...
                        <form method="POST" action="{{route('register')}}" data-toggle="validator">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="first-name"  name="first_name" value="{{old('first_name')}}" class="form-control" type="text" placeholder=" "  required autofocus >
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="last-name" class="form-label">Last Name <span class="text-danger">*</span></label>
                                    <input id="last-name"  name="last_name" value="{{old('last_name')}}" class="form-control" type="text" placeholder=" "  required autofocus >
                                </div>
                            </div>
