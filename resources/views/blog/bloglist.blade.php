                  ...
                  <div class="row align-items-center">
                     ...
                     <div class="col-md-6">
                        <div class="blog-description p-2">
                           ...
                           <a href="#" class="d-flex align-items-center" tabindex="-1">Read More <i class="material-symbols-outlined fs-6 icon-rtl">arrow_forward_ios</i></a>
                     ...
                     <div class="col-md-6">
                        <div class="blog-description p-2">
                           ...
                           <div class="group-smile mt-4 d-flex flex-wrap align-items-center justify-content-between position-right-side">
                              ...
                              <div class="comment"><i class="material-symbols-outlined me-2 md-18"></i>7 comments</div>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="image-block">
                           <img src="{{asset('images/blog/02.jpg')}}" class="img-fluid rounded w-100" alt="blog-img" loading="lazy">
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="card card-block card-stretch card-height blog-list">
               <div class="card-body">
                  <div class="row align-items-center">
                     <div class="col-md-6">
                        <div class="image-block">
                           <img src="{{asset('images/blog/05.jpg')}}" class="img-fluid rounded w-100" alt="blog-img" loading="lazy">
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="blog-description p-2">
            ...
            <div class="card card-block card-stretch card-height blog-list list-even">
               <div class="card-body">
                  <div class="row align-items-center">
                     ...
                     <div class="col-md-6">
                        <div class="image-block">
                           <img src="{{asset('images/blog/06.jpg')}}" class="img-fluid rounded w-100" alt="blog-img" loading="lazy">
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="card card-block card-stretch card-height blog-list">
               <div class="card-body">
                  <div class="row align-items-center">
                     <div class="col-md-6">
                        <div class="image-block">
                           <img src="{{asset('images/blog/07.jpg')}}" class="img-fluid rounded w-100" alt="blog-img" loading="lazy">
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="blog-description p-2">
            ...
            <div class="card card-block card-stretch card-height blog-list list-even">
               <div class="card-body">
                  <div class="row align-items-center">
                     ...
                     <div class="col-md-6">
                        <div class="image-block">
                           <img src="{{asset('images/blog/08.jpg')}}" class="img-fluid rounded w-100" alt="blog-img" loading="lazy">
                        </div>
                     </div>
                  </div>
               </div>
