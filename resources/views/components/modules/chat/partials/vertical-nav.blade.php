...
{{-- <ul class="nav navbar-nav iq-main-menu mb-5 pb-5" id="sidebar-menu" role="tablist">
    ...
    <x-modules.chat.widgets.user-list id="102" status="Online" userName="John Travolta" lastMessage="01:10 PM"  userProfileImg="avatar/02.png" userMessage="Lorem ipsum" unreadMessage="20"/>
     <x-modules.chat.widgets.user-list id="103" status="Online" status-identify="Online" lastMessage="05:09 AM"  userName="Barb Ackue" userProfileImg="avatar/03.png" userMessage="Lorem ipsum"/>
     <x-modules.chat.widgets.user-list id="104" status="Online" userName="Robert Fox" userProfileImg="avatar/04.png" lastMessage="01:10 PM"  userMessage="Lorem ipsum"/>
    <x-modules.chat.widgets.user-list id="105" userName="Maya Didas" userProfileImg="avatar/05.png" lastMessage="01:10 PM"  userMessage="Lorem ipsum"/>
    <x-modules.chat.widgets.user-list id="106" status="Online" status-identify="Online" userName="Monty Carlo" lastMessage="01:10 PM"  userProfileImg="avatar/06.png" userMessage="Lorem Ipsum"/>
