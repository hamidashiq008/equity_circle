                            ...
                            <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="me-3 flex-shrik-0">
                                            <img class="border border-2 rounded-circle user-post-profile"
                                                src="{{asset('images/user.jpg')}}" alt="user-image"
                                                loading="lazy">
                                        </div>
                                        <div class="w-100">
                                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="user-post mt-4">
                                    <a data-fslightbox="gallery" href="{{ asset('/images/page-img/fun.jpg') }}"
                                        class="rounded">
                                        <img src="{{asset('images/abussiness(2).jpg')}}" alt="post-image"
                                ...
                                <div class="post-meta-likes mt-4">
                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                        <ul class="list-inline m-0 p-0 post-user-liked-list">
                                            <li>
                                                <img src="{{asset('images/')}}" alt=""
                                                    class="rounded-circle img-fluid " loading="lazy">
                                            </li>
                                            <li>
                                                <img src="{{asset('images/')}}" alt=""
                                                    class="rounded-circle img-fluid " loading="lazy">
                        ...
                        <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="card-post-toolbar">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu m-0 p-0">
                                                        <a class="dropdown-item p-3" href="{{asset('images/')}}">
                                                            <div class="d-flex align-items-top">
                                                                <span class="material-symbols-outlined">
                                                                    save
                                                                </span>
                            ...
                            <div class="user-post mt-4">
                                <div class="text-center">
                                    <img src="{{asset('images/abussiness(6).jpg')}}" alt="ads" class="img-fluid">
