                        ...
                        <div class="card card-block card-stretch card-height">
                           <div class="card-body">
                              <div class="user-post-data">
                                 <div class="d-flex align-items-center justify-content-between">
                                    <div class="me-3 flex-shrik-0">
                                       <img class="border border-2 rounded-circle user-post-profile" src="{{URL::asset('/images/user/03.jpg')}}" alt="user-image" loading="lazy">
                                    </div>
                                    <div class="w-100">
                                       <div class="d-flex align-items-center justify-content-between">
                                          <div>
                              ...
                              <div class="user-post mt-4">
                                 <div class="row">
                                    <div class="col-md-4">
                                       <a data-fslightbox="gallery" href="{{URL::asset('/images/bussiness(5).jpg')}}" class="rounded">
                                          <img src="{{URL::asset('/images/bussiness(5).jpg')}}" alt="post-image" class="img-fluid rounded w-100 h-100" loading="lazy">
                                       </a>
                                    </div>
                                    <div class="col-md-4 mt-md-0 mt-3">
                                       <a data-fslightbox="gallery" href="{{URL::asset('/images/bussiness(6).jpg')}}" class="rounded">
                                          <img src="{{URL::asset('/images/bussiness(6).jpg')}}" alt="post-image" class="img-fluid rounded w-100 h-100" loading="lazy">
                                       </a>
                                    </div>
                                    <div class="col-md-4 mt-md-0 mt-3">
                                       <a data-fslightbox="gallery" href="{{URL::asset('/images/bussiness(8).jpg')}}" class="rounded">
                                          <img src="{{URL::asset('/images/bussiness(8).jpg')}}" alt="post-image" class="img-fluid rounded w-100 h-100" loading="lazy">
                                       </a>
                                    </div>
                                 </div>
                                 <div class="row mt-3">
                                    <div class="col-md-6">
                                       <a data-fslightbox="gallery" href="{{URL::asset('/images/bussiness(9).jpg')}}" class="rounded">
                                          <img src="{{URL::asset('/images/bussiness(9).jpg')}}" alt="post-image" class="img-fluid rounded w-100 h-100" loading="lazy">
                                       </a>
                                    </div>
                                    <div class="col-md-6 mt-md-0 mt-3">
                                       <div class="post-overlay-box h-100 rounded">
                                          <img src="{{URL::asset('/images/bussiness(4).jpg')}}" alt="post-image" class="img-fluid rounded w-100 h-100 object-cover" loading="lazy">
                                          <a data-fslightbox="gallery" href="{{URL::asset('/images/bussiness(4).jpg')}}" class="rounded font-size-18">+2
                                          </a>
                                       </div>
                                    </div>
                                 </div>
                              ...
                              <div class="post-meta-likes mt-4">
                                 <div class="d-flex align-items-center gap-2 flex-wrap">
                                    <ul class="list-inline m-0 p-0 post-user-liked-list">
                                       <li>
                                          <img src="{{URL::asset('/images/user/01.jpg')}}" alt="userimg" class="rounded-circle img-fluid userimg" loading="lazy">
                                       </li>
                                       <li>
                                          <img src="{{URL::asset('/images/user/02.jpg')}}" alt="userimg" class="rounded-circle img-fluid userimg" loading="lazy">
                                       </li>
                                       <li>
                                          <img src="{{URL::asset('/images/user/03.jpg')}}" alt="userimg" class="rounded-circle img-fluid userimg" loading="lazy">
                                       </li>
                                       <li>
                                          <img src="{{URL::asset('/images/user/04.jpg')}}" alt="userimg" class="rounded-circle img-fluid userimg" loading="lazy">
                                       </li>
                                    </ul>
                                          ...
                                          <div class="comment-list-block">
                                             <div class="d-flex align-items-center gap-3">
                                                <div class="comment-list-user-img flex-shrink-0">
                                                   <img src="{{URL::asset('/images/user/13.jpg')}}" alt="userimg" class="avatar-48 rounded-circle img-fluid" loading="lazy">
                                                </div>
                                                   ...
                                                   <div class="add-comment-form-block collapse mt-3" id="subcomment-collapse2">
                                                      <div class="d-flex align-items-center gap-3">
                                                         <div class="flex-shrink-0">
                                                            <img src="{{URL::asset('/images/user/1.jpg')}}" alt="userimg" class="avatar-48 rounded-circle img-fluid" loading="lazy">
                                                         </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="user-post mt-4">
                                    <div class="ratio ratio-16x9">
                                        <iframe src="https://www.youtube.com/embed/HE9JioDuXkQ"
                        ...
                        <div class="card-body">
                            ...
                            <div class="user-post mt-4">
                                <div class="text-center">
                                    <img src="{{ asset('/images/bussiness(1).jpg') }}" alt="ads" class="img-fluid">
