                        ...
                        <div class="chat-search pt-3 ps-3">
                           <div class="d-flex align-items-center">
                              <div class="chat-profile me-3">
                                 <img src="{{asset('images/user/1.jpg')}}" alt="chat-user" class="avatar-60 ">
                              </div>
                           ...
                           <div id="user-detail-popup" class="scroller">
                              <div class="user-profile">
                                 ...
                                 <div class="user text-center mb-4">
                                    <a class="avatar m-0">
                                    <img src="{{asset('images/user/1.jpg')}}" alt="avatar">
                                    </a>
                                 ...
                                 <div class="user-detail text-left mt-4 ps-4 pe-4">
                                    ...
                                    <ul class="user-status p-0">
                                       <li class="mb-1"><i class="material-symbols-outlined filled text-success pe-1 md-14">
                                          circle
                                       </i><span>Online</span></li>
                                       <li class="mb-1"><i class="material-symbols-outlined filled text-warning pe-1 md-14">
                                          circle
                                       </i><span>Away</span></li>
                                       <li class="mb-1"><i class="material-symbols-outlined filled text-danger pe-1 md-14">
                                          circle
                                       </i></i><span>Do Not Disturb</span></li>
                                       <li class="mb-1"><i class="material-symbols-outlined filled text-light pe-1 md-14">
                                          circle
                                       </i><span>Offline</span></li>
                                    </ul>
                                 </div>
                              </div>
                           </div>
                           ...
                           <ul class="iq-chat-ui nav flex-column nav-pills">
                                 ...
                                 <a  data-bs-toggle="pill" href="#chatbox1">
                                    <div class="d-flex align-items-center">
                                       <div class="avatar me-2">
                                          <img src="{{asset('images/user/05.jpg')}}" alt="chatuserimage" class="avatar-50 ">
                                          <span class="avatar-status"><i class="material-symbols-outlined filled text-success md-14">
                                                circle
                                             </i></span>
                                       </div>
                              ...
                              <li>
                                 <a  data-bs-toggle="pill" href="#chatbox2">
                                    <div class="d-flex align-items-center">
                                       <div class="avatar me-2">
                                          <img src="{{asset('images/user/06.jpg')}}" alt="chatuserimage" class="avatar-50 ">
                                          <span class="avatar-status"><i class="material-symbols-outlined filled text-success md-14">
                                                circle
                                             </i></span>
                                       </div>
                           ...
                           <ul class="iq-chat-ui nav flex-column nav-pills">
                              <li>
                                 <a  data-bs-toggle="pill" href="#chatbox3">
                                    <div class="d-flex align-items-center">
                                       <div class="avatar me-2">
                                          <img src="{{asset('images/user/07.jpg')}}" alt="chatuserimage" class="avatar-50 ">
                                          <span class="avatar-status"><i class="material-symbols-outlined filled text-warning pe-1 md-14">
                                             circle
                                          </i></span>
                                       </div>
                                       <div class="chat-sidebar-name">
                              ...
                              <li>
                                 <a  data-bs-toggle="pill" href="#chatbox4">
                                    <div class="d-flex align-items-center">
                                       <div class="avatar me-2">
                                          <img src="{{asset('images/user/08.jpg')}}" alt="chatuserimage" class="avatar-50 ">
                                          <span class="avatar-status"><i class="material-symbols-outlined filled text-success md-14">
                                                circle
                                             </i></span>
                                       </div>
                              ...
                              <li>
                                 <a  data-bs-toggle="pill" href="#chatbox5">
                                    <div class="d-flex align-items-center">
                                       <div class="avatar me-2">
                                          <img src="{{asset('images/user/09.jpg')}}" alt="chatuserimage" class="avatar-50 ">
                           ...
                           <ul class="iq-chat-ui nav flex-column nav-pills">
                              <li>
                                 <a  data-bs-toggle="pill" href="#chatbox6">
                                    <div class="d-flex align-items-center">
                                       <div class="avatar me-2">
                                          <img src="{{asset('images/user/10.jpg')}}" alt="chatuserimage" class="avatar-50 ">
                              ...
                              <li>
                                 <a  data-bs-toggle="pill" href="#chatbox8">
                                    <div class="d-flex align-items-center">
                                       <div class="avatar me-2">
                                          <img src="{{asset('images/user/06.jpg')}}" alt="chatuserimage" class="avatar-50 ">
                                          <span class="avatar-status"><i class="material-symbols-outlined text-primary filled md-14">
                                             circle
                                             </i></span>
                                       </div>
                                       <div class="chat-sidebar-name">
                           ...
                           <div class="tab-pane fade" id="chatbox1" role="tabpanel">
                                 ...
                                 <header class="d-flex justify-content-between align-items-center bg-white pt-3 pe-3 pb-3">
                                    <div class="d-flex align-items-center">
                                       ...
                                       <div class="avatar chat-user-profile m-0 me-3">
                                          <img src="{{asset('images/user/05.jpg')}}" alt="avatar" class="avatar-50 ">
                                          <span class="avatar-status"><i class="material-symbols-outlined filled text-success md-14">
                                                circle
                                             </i></span>
                                       </div>
                                    ...
                                    <div class="chat-user-detail-popup scroller">
                                       <div class="user-profile">
                                          ...
                                          <div class="user mb-4  text-center">
                                             <a class="avatar m-0">
                                             <img src="{{asset('images/user/05.jpg')}}" alt="avatar">
                                             </a>
                                             <div class="user-name mt-4">
                                                <h4>Bni Jordan</h4>
                                             </div>
                              ...
                              <div class="chat-content scroller">
                                 <div class="chat d-flex other-user">
                                    <div class="chat-user">
                                       <a class="avatar m-0">
                                       <img src="{{asset('images/user/1.jpg')}}" alt="avatar" class="avatar-35 ">
                                       </a>
                                 ...
                                 <div class="chat chat-left">
                                    <div class="chat-user">
                                       <a class="avatar m-0">
                                       <img src="{{asset('images/user/05.jpg')}}" alt="avatar" class="avatar-35 ">
                                       </a>
                           ...
                           <div class="tab-pane fade" id="chatbox2" role="tabpanel">
                              <div class="chat-head">
                                 <header class="d-flex justify-content-between align-items-center bg-white pt-3  ps-3 pe-3 pb-3">
                                    <div class="d-flex align-items-center">
                                       ...
                                       <div class="avatar chat-user-profile m-0 me-3">
                                          <img src="{{asset('images/user/06.jpg')}}" alt="avatar" class="avatar-50 ">
                                          <span class="avatar-status"><i class="material-symbols-outlined filled text-success md-14">
                                                circle
                                             </i></span>
                                       </div>
                                    ...
                                    <div class="chat-user-detail-popup scroller" >
                                       <div class="user-profile">
                                          ...
                                          <div class="user mb-4 text-center">
                                             <a class="avatar m-0">
                                             <img src="{{asset('images/user/06.jpg')}}" alt="avatar">
                                             </a>
                                             <div class="user-name mt-4">
                                                <h4>Mark Jordan</h4>
                                             </div>
                              ...
                              <div class="chat-content scroller">
                                 ...
                                 <div class="chat chat-left">
                                    <div class="chat-user">
                                       <a class="avatar m-0">
                                       <img src="{{asset('images/user/06.jpg')}}" alt="avatar" class="avatar-35 ">
                                       </a>
                                       <span class="chat-time mt-1">6:48</span>
                                    </div>
                                    <div class="chat-detail">
                           ...
                           <div class="tab-pane fade" id="chatbox3" role="tabpanel">
                              <div class="chat-head">
                                 <header class="d-flex justify-content-between align-items-center bg-white pt-3 ps-3 pe-3 pb-3">
                                    <div class="d-flex align-items-center">
                                       ...
                                       <div class="avatar chat-user-profile m-0 me-3">
                                          <img src="{{asset('images/user/07.jpg')}}" alt="avatar" class="avatar-50 ">
                                          <span class="avatar-status"><i class="material-symbols-outlined filled text-success md-14">
                                                circle
                                             </i></span>
                                       </div>
                                    ...
                                    <div class="chat-user-detail-popup scroller">
                                       <div class="user-profile ">
                                          ...
                                          <div class="user text-center mb-4">
                                             <a class="avatar m-0">
                                             <img src="{{asset('images/user/07.jpg')}}" alt="avatar">
                                             </a>
                                             <div class="user-name mt-4">
                                                <h4>Paige Turner</h4>
                                             </div>
                              ...
                              <div class="chat-content scroller">
                                 ...
                                 <div class="chat chat-left">
                                    <div class="chat-user">
                                       <a class="avatar m-0">
                                       <img src="{{asset('images/user/07.jpg')}}" alt="avatar" class="avatar-35 ">
                                       </a>
                                       <span class="chat-time mt-1">6:48</span>
                                    </div>
                                    <div class="chat-detail">
                           ...
                           <div class="tab-pane fade" id="chatbox4" role="tabpanel">
                              <div class="chat-head">
                                 <header class="d-flex justify-content-between align-items-center bg-white pt-3 ps-3 pe-3 pb-3">
                                    <div class="d-flex align-items-center">
                                       ...
                                       <div class="avatar chat-user-profile m-0 me-3">
                                          <img src="{{asset('images/user/08.jpg')}}" alt="avatar" class="avatar-50 ">
                                          <span class="avatar-status"><i class="material-symbols-outlined filled text-success md-14">
                                                circle
                                             </i></span>
                                       </div>
                                    ...
                                    <div class="chat-user-detail-popup scroller">
                                       <div class="user-profile ">
                                          ...
                                          <div class="user mb-4 text-center">
                                             <a class="avatar m-0">
                                             <img src="{{asset('images/user/08.jpg')}}" alt="avatar">
                                             </a>
                                             <div class="user-name mt-4">
                                                <h4>Barb Ackue</h4>
                                             </div>
                              ...
                              <div class="chat-content scroller">
                                 ...
                                 <div class="chat chat-left">
                                    <div class="chat-user">
                                       <a class="avatar m-0">
                                       <img src="{{asset('images/user/08.jpg')}}" alt="avatar" class="avatar-35 ">
                                       </a>
                                       <span class="chat-time mt-1">6:48</span>
                                    </div>
                                    <div class="chat-detail">
                           ...
                           <div class="tab-pane fade" id="chatbox5" role="tabpanel">
                              <div class="chat-head">
                                 <header class="d-flex justify-content-between align-items-center bg-white pt-3 ps-3 pe-3 pb-3">
                                    <div class="d-flex align-items-center">
                                       ...
                                       <div class="avatar chat-user-profile m-0 me-3">
                                          <img src="{{asset('images/user/09.jpg')}}" alt="avatar" class="avatar-50 ">
                                          <span class="avatar-status"><i class="material-symbols-outlined filled text-success md-14">
                                                circle
                                             </i></span>
                                       </div>
                                    ...
                                    <div class="chat-user-detail-popup scroller">
                                       <div class="user-profile ">
                                          ...
                                          <div class="user mb-4 text-center">
                                             <a class="avatar m-0">
                                             <img src="{{asset('images/user/09.jpg')}}" alt="avatar">
                                             </a>
                                             <div class="user-name mt-4">
                                                <h4>Peta Saireya</h4>
                                             </div>
                              ...
                              <div class="chat-content scroller">
                                 ...
                                 <div class="chat chat-left">
                                    <div class="chat-user">
                                       <a class="avatar m-0">
                                       <img src="{{asset('images/user/09.jpg')}}" alt="avatar" class="avatar-35 ">
                                       </a>
                                       <span class="chat-time mt-1">6:48</span>
                                    </div>
                                    <div class="chat-detail">
                           ...
                           <div class="tab-pane fade" id="chatbox6" role="tabpanel">
                              <div class="chat-head">
                                 <header class="d-flex justify-content-between align-items-center bg-white pt-3 ps-3 pe-3 pb-3">
                                    <div class="d-flex align-items-center">
                                       ...
                                       <div class="avatar chat-user-profile m-0 me-3">
                                          <img src="{{asset('images/user/10.jpg')}}" alt="avatar" class="avatar-50 ">
                                          <span class="avatar-status"><i class="material-symbols-outlined filled text-success md-14">
                                                circle
                                             </i></span>
                                       </div>
                                    ...
                                    <div class="chat-user-detail-popup scroller">
                                       <div class="user-profile ">
                                          ...
                                          <div class="user mb-4 text-center">
                                             <a class="avatar m-0">
                                             <img src="{{asset('images/user/10.jpg')}}" alt="avatar">
                                             </a>
                                             <div class="user-name mt-4">
                                                <h4>Paul Molive</h4>
                                             </div>
                              ...
                              <div class="chat-content scroller">
                                 ...
                                 <div class="chat chat-left">
                                    <div class="chat-user">
                                       <a class="avatar m-0">
                                       <img src="{{asset('images/user/10.jpg')}}" alt="avatar" class="avatar-35 ">
                                       </a>
                                       <span class="chat-time mt-1">6:48</span>
                                    </div>
                                    <div class="chat-detail">
