    ...
    <x-slot name="header">
        <div class="header-for-bg">
            <div class="background-header position-relative">
                <img src="{{asset('images/page-img/profile-bg7.jpg')}}" class="img-fluid w-100 rounded rounded"
                    alt="header-bg">
                ...
                <div class="d-flex align-items-center justify-content-between mb-3 flex-wrap">
                    <div class="group-info d-flex align-items-center">
                        <div class="me-3">
                            <img class="rounded-circle img-fluid avatar-100"
                                src="{{asset('/images/page-img/gi-1.jpg')}}" alt="" loading="lazy">
                        </div>
                        <div class="info">
                            <h4>Birthday celebration</h4>
                            <p class="mb-0 d-flex"><i class="material-symbols-outlined pe-2">lock</i>Private Group . 323
                                members</p>
                        </div>
                    </div>
                    <div class="group-member d-flex align-items-center  mt-md-0 mt-2">
                        <div class="iq-media-group me-3">
                            ...
                            <a href="javascript:void(0);" class="iq-media">
                                <img class="img-fluid avatar-40 rounded-circle" src="{{asset('/images/user/11.jpg')}}"
                                    alt="" loading="lazy">
                            </a>
                            <a href="javascript:void(0);" class="iq-media">
                                <img class="img-fluid avatar-40 rounded-circle" src="{{asset('/images/user/12.jpg')}}"
                                    alt="" loading="lazy">
                            </a>
                        </div>
                        <button type="submit" class="btn btn-primary d-flex gap-2"><i
                                class="material-symbols-outlined">add</i>Invite</button>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="card">
                                ...
                                <div class="dropdown-menu m-0 p-0">
                                    <a class="dropdown-item p-3" href="javascript:void(0);">
                                        <div class="d-flex align-items-top">
                                            <div class="icon h4"><i class="material-symbols-outlined">notifications</i>
                                            </div>
                                            <div class="data ms-2">
                                                <h6>Notifications</h6>
                                    ...
                                    <a class="dropdown-item p-3" href="javascript:void(0);">
                                        <div class="d-flex align-items-top">
                                            <div class="icon h4"><i class="material-symbols-outlined"> push_pin</i>
                                            </div>
                                            <div class="data ms-2">
                                                <h6>Pins</h6>
                                    ...
                                    <a class="dropdown-item p-3" href="javascript:void(0);">
                                        <div class="d-flex align-items-top">
                                            <div class="icon h4"><i class="material-symbols-outlined">edit</i></div>
                                            <div class="data ms-2">
                                                <h6>Following</h6>
                                                <p class="mb-0">Follow or unfollow groups <br>to control in News Feed.
                                                </p>
                                            </div>
                                        </div>
                                    </a>
                                    <a class="dropdown-item p-3" href="javascript:void(0);">
                                        <div class="d-flex align-items-top">
                                            <div class="icon h4"><i class="material-symbols-outlined">cancel</i></div>
                                            <div class="data ms-2">
                                                <h6>Membership</h6>
                    ...
                    <div class="card-body">
                        <ul class="list-inline p-0 m-0">
                            <li class="mb-md-3 pb-md-3 border-bottom members-list">
                                <div class="iq-search-bar members-search p-0">
                                    <form action="#" class="searchbox w-auto">
                                        <input type="text" class="text search-input bg-primary-subtle"
                            ...
                            <li class="mb-3 d-flex align-items-center gap-2">
                                <div class="d-flex"><i class="material-symbols-outlined h4">arrow_forward</i></div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="list-inline p-0 m-0">
                            <li class="mb-3">
                                <p class="mb-0">Event Planning's...</p>
                            </li>
                            <li class="mb-3 d-flex align-items-center">
                                <div
                                    class="avatar-40 rounded-circle bg-gray d-flex align-items-center justify-content-center me-3">
                                    <i class="material-symbols-outlined h4">pin_drop</i>
                                </div>
                            ...
                            <li class="mb-3 d-flex align-items-center">
                                <div
                                    class="avatar-40 rounded-circle bg-gray d-flex align-items-center justify-content-center me-3">
                                    <i class="material-symbols-outlined h4">local_shipping</i>
                                </div>
                            ...
                            <li class="mb-3 d-flex align-items-center">
                                <div
                                    class="avatar-40 rounded-circle bg-gray d-flex align-items-center justify-content-center me-3">
                                    <i class="material-symbols-outlined h4">restaurant_menu</i>
                                </div>
                            ...
                            <li class="mb-3 d-flex align-items-center">
                                <div
                                    class="avatar-40 rounded-circle bg-gray d-flex align-items-center justify-content-center me-3">
                                    <i class="material-symbols-outlined h4">home</i>
                                </div>
                            ...
                            <li class="mb-3 d-flex align-items-center">
                                <div
                                    class="avatar-40 rounded-circle bg-gray d-flex align-items-center justify-content-center me-3">
                                    <i class="material-symbols-outlined h4">location_city</i>
                                </div>
                            ...
                            <li class="mb-3 d-flex align-items-center">
                                <div
                                    class="avatar-40 rounded-circle bg-gray d-flex align-items-center justify-content-center me-3">
                                    <i class="material-symbols-outlined h4">work</i>
                                </div>
                            ...
                            <li class="mb-3 d-flex align-items-center">
                                <div
                                    class="avatar-40 rounded-circle bg-gray d-flex align-items-center justify-content-center me-3">
                                    <i class="material-symbols-outlined h4">import_contacts</i>
                                </div>
                ...
                <div id="post-modal-data" class="card">
                    ...
                    <div class="card-body">
                        ...
                        <ul class=" post-opt-block d-flex list-inline m-0 p-0 flex-wrap">
                            <li
                                class="bg-primary-subtle rounded p-2 pointer d-flex align-items-center me-3 mb-md-0 mb-2">
                            ...
                            <li class="bg-primary-subtle rounded p-2 pointer d-flex align-items-center me-3"><img
                            ...
                            <li class="bg-primary-subtle rounded p-2 pointer text-center">
                                <div class="card-header-toolbar d-flex align-items-center">
                                    <div class="dropdown">
                                        <a href="javascript:void(0);" class="dropdown-toggle d-flex" id="post-option"
                                            data-bs-toggle="dropdown">
                                            <i class="material-symbols-outlined h4">more_horiz</i>
                                        </a>
                                    ...
                                    <ul class="d-flex flex-wrap align-items-center list-inline m-0 p-0">
                                        <li class="col-md-6 mb-3">
                                            <div class="bg-primary-subtle rounded p-2 pointer me-3"><a
                                                    href="javascript:void(0);"></a><img
                                                    src="{{asset('/images/small/07.png')}}" alt="icon" class="img-fluid"
                                                    loading="lazy"> Photo/Video</div>
                                        </li>
                                        <li class="col-md-6 mb-3">
                                            <div class="bg-primary-subtle rounded p-2 pointer me-3"><a
                                                    href="javascript:void(0);"></a><img
                                                    src="{{asset('/images/small/08.png')}}" alt="icon" class="img-fluid"
                                                    loading="lazy"> Tag Friend</div>
                                        </li>
                                        <li class="col-md-6 mb-3">
                                            <div class="bg-primary-subtle rounded p-2 pointer me-3"><a
                                                    href="javascript:void(0);"></a><img
                                                    src="{{asset('/images/small/09.png')}}" alt="icon" class="img-fluid"
                                                    loading="lazy"> Feeling/Activity</div>
                                        </li>
                                        <li class="col-md-6 mb-3">
                                            <div class="bg-primary-subtle rounded p-2 pointer me-3"><a
                                                    href="javascript:void(0);"></a><img
                                        ...
                                        <li class="col-md-6 mb-3">
                                            <div class="bg-primary-subtle rounded p-2 pointer me-3"><a
                                                    href="javascript:void(0);"></a><img
                                                    src="{{asset('/images/small/11.png')}}" alt="icon" class="img-fluid"
                                                    loading="lazy"> Live Video</div>
                                        </li>
                                        <li class="col-md-6 mb-3">
                                            <div class="bg-primary-subtle rounded p-2 pointer me-3"><a
                                                    href="javascript:void(0);"></a><img
                                                    src="{{asset('/images/small/12.png')}}" alt="icon" class="img-fluid"
                                            ...
                                            <div class="card-post-toolbar">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu m-0 p-0">
                                                        <a class="dropdown-item p-3" href="javascript:void(0);">
                                                            <div class="d-flex align-items-top">
                                                                <i class="material-symbols-outlined h4">save</i>
                                                                <div class="data ms-2">
                                                                    <h6>Public</h6>
                                                        ...
                                                        <a class="dropdown-item p-3" href="javascript:void(0);">
                                                            <div class="d-flex align-items-top">
                                                                <i class="material-symbols-outlined h4">cancel</i>
                                                                <div class="data ms-2">
                                                                    <h6>Friends</h6>
                                                        ...
                                                        <a class="dropdown-item p-3" href="javascript:void(0);">
                                                            <div class="d-flex align-items-top">
                                                                <i
                                                                    class="material-symbols-outlined h4">person_remove</i>
                                                                <div class="data ms-2">
                                                        ...
                                                        <a class="dropdown-item p-3" href="javascript:void(0);">
                                                            <div class="d-flex align-items-top">
                                                                <i
                                                                    class="material-symbols-outlined h4">notifications</i>
                                                                <div class="data ms-2">
                                                                    <h6>Only Me</h6>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="post-item">
                            <div class="user-post-data pb-3">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between">
                                            <div class="">
                                                <h5 class="mb-0 d-inline-block"><a href="javascript:void(0);"
                                            ...
                                            <div class="card-post-toolbar">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu m-0 p-0">
                                                        ...
                                                        <a class="dropdown-item p-3" href="javascript:void(0);">
                                                            <div class="d-flex align-items-top">
                                                                <i class="material-symbols-outlined h4">edit</i>
                                                                <div class="data ms-2">
                                                                    <h6>Edit Post</h6>
                                                        ...
                                                        <a class="dropdown-item p-3" href="javascript:void(0);">
                                                            <div class="d-flex align-items-top">
                                                                <i class="material-symbols-outlined h4">delete</i>
                                                                <div class="data ms-2">
                                                                    <h6>Delete</h6>
                            ...
                            <div class="user-post">
                                <a href="javascript:void(0);"><img src="{{asset('/images/page-img/52.jpg')}}"
                                        alt="post-image" loading="lazy" class="img-fluid w-100" /></a>
                            </div>
                            <div class="comment-area mt-3">
                                <div class="d-flex justify-content-between align-items-center flex-wrap">
                                            ...
                                            <div class="like-data">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu py-2">
                                                        ...
                                                        <a class="me-2" href="javascript:void(0);"
                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                            title="Sade"><img src="{{asset('/images/icon/06.png')}}"
                                                                class="img-fluid" alt=""></a>
                                                        <a class="me-2" href="javascript:void(0);"
                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                            ...
                                            <div class="total-like-block ms-2 me-3">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item" href="javascript:void(0);">Bill
                                                            Yerds</a>
                                                        <a class="dropdown-item" href="javascript:void(0);">Hap E.
                                                            Birthday</a>
                                                        <a class="dropdown-item" href="javascript:void(0);">Tara
                                                            Misu</a>
                                                        <a class="dropdown-item" href="javascript:void(0);">Midge
                                                            Itz</a>
                                                        <a class="dropdown-item" href="javascript:void(0);">Sal
                                                            Vidge</a>
                                    ...
                                    <div class="share-block d-flex align-items-center feather-icon mt-2 mt-md-0">
                                        <a class="d-flex align-items-center" href="javascript:void(0);"
                                            ...
                                            aria-controls="share-btn"><i class="material-symbols-outlined">share</i>
                                ...
                                <form class="comment-text d-flex align-items-center mt-3" action="javascript:void(0);">
                                    ...
                                    <div class="comment-attagement d-flex align-items-center">
                                        <a class="material-symbols-outlined me-3 link"
                                            href="javascript:void(0);">insert_link</a>
                                        <a href="javascript:void(0);"
                                            class="material-symbols-outlined me-3">sentiment_satisfied</a>
                                        <a href="javascript:void(0);"
                                            class="material-symbols-outlined me-3">photo_camera</a>
                                    </div>
                                </form>
                            </div>
                        </div>
                        <div class="post-item">
                            <div class="user-post-data py-3">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="w-100">
                                        <div class="d-flex justify-content-between">
                                            <div class="">
                                                <h5 class="mb-0 d-inline-block me-1"><a href="javascript:void(0);"
                            ...
                            <div class="user-post">
                                <a href="javascript:void(0);"><img src="{{asset('/images/page-img/60.jpg')}}"
                                        alt="post-image" loading="lazy" class="img-fluid w-100" /></a>
                            </div>
                            <div class="comment-area mt-3">
                                <div class="d-flex justify-content-between align-items-center flex-wrap">
