                        ...
                        <div class="card card-block card-stretch card-height">
                           <div class="card-body">
                              ...
                              <div class="user-post mt-4">
                                 <div class="row">
                                    <div class="col-md-4">
                                       <a data-fslightbox="gallery" href="{{URL::asset('/images/gym.jpg')}}" class="rounded">
                                          <img src="{{URL::asset('/images/gym.jpg')}}" alt="post-image" class="img-fluid rounded w-100 h-100" loading="lazy">
                                       </a>
                                    </div>
                                    <div class="col-md-4 mt-md-0 mt-3">
                                       <a data-fslightbox="gallery" href="{{URL::asset('/images/gym(9).jpg')}}" class="rounded">
                                          <img src="{{URL::asset('/images/gym(9).jpg')}}" alt="post-image" class="img-fluid rounded w-100 h-100" loading="lazy">
                                       </a>
                                    </div>
                                    <div class="col-md-4 mt-md-0 mt-3">
                                       <a data-fslightbox="gallery" href="{{URL::asset('/images/gym(4).jpg')}}" class="rounded">
                                          <img src="{{URL::asset('/images/gym(4).jpg')}}" alt="post-image" class="img-fluid rounded w-100 h-100" loading="lazy">
                                       </a>
                                    </div>
                                 </div>
                                 <div class="row mt-3">
                                    <div class="col-md-6">
                                       <a data-fslightbox="gallery" href="{{URL::asset('/images/gym(1).jpg')}}" class="rounded">
                                          <img src="{{URL::asset('/images/gym(1).jpg')}}" alt="post-image" class="img-fluid rounded w-100 h-100" loading="lazy">
                                       </a>
                                    </div>
                                    <div class="col-md-6 mt-md-0 mt-3">
                                       <div class="post-overlay-box h-100 rounded">
                                          <img src="{{URL::asset('/images/gym(3).jpg')}}" alt="post-image" class="img-fluid rounded w-100 h-100 object-cover" loading="lazy">
                                          <a data-fslightbox="gallery" href="{{URL::asset('/images/gym(3).jpg')}}" class="rounded font-size-18">+2
                                          </a>
                                       </div>
                                    </div>
                                 </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="user-post mt-4">
                                    <div class="ratio ratio-16x9">
                                        <iframe src="https://www.youtube.com/embed/ihSGXbXwJMM"
                        ...
                        <div class="card-body">
                            ...
                            <div class="user-post mt-4">
                                <div class="text-center">
                                    <img src="{{ asset('/images/gym.jpg') }}" alt="ads" class="img-fluid">
