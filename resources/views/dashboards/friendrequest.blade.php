              ...
              <div class="card">
                 ...
                 <div class="card-body pt-0">
                    <ul class="request-list list-inline m-0 p-0">
                       <li class="d-flex align-items-center justify-content-between">
                          ...
                          <div class="d-flex align-items-center mt-2 mt-md-0">
                             <div class="confirm-click-btn">
                                <a href="#" class="me-2 btn btn-success-subtle rounded confirm-btn p-1 lh-1">
                       ...
                       <li class="d-flex align-items-center justify-content-between border-0">
                          <div class="d-flex align-items-center">
                             <div class="user-img img-fluid flex-shrink-0">
                    ...
                    <ul class="request-list m-0 p-0">
                       <li class="d-flex align-items-center justify-content-between">
                          <div class="d-flex align-items-center">
                             ...
                             <div class="user-img img-fluid flex-shrink-0">
                                <img src="{{asset('images/user/15.jpg')}}" alt="story-img" class="rounded-circle avatar-40" loading="lazy">
                             </div>
                             <div class="flex-grow-1 ms-3">
                                <h6>Jen Youfelct</h6>
                       ...
                       <li class="d-flex align-items-center justify-content-between">
                          ...
                          <div class="user-img img-fluid flex-shrink-0">
                             <img src="{{asset('images/user/16.jpg')}}" alt="story-img" class="rounded-circle avatar-40" loading="lazy">
                          </div>
                          <div class="flex-grow-1 ms-3">
                             <h6>Cooke Edoh</h6>
                       ...
                       <li class="d-flex align-items-center justify-content-between">
                          ...
                          <div class="user-img img-fluid flex-shrink-0">
                             <img src="{{asset('images/user/17.jpg')}}" alt="story-img" class="rounded-circle avatar-40" loading="lazy">
                          </div>
                          <div class="flex-grow-1 ms-3">
                             <h6>Earl E. Riser</h6>
