            ...
            <div class="row " style="height: 100vh;">
                <div class="col-md-7 col-lg-7 overflow-hidden position-relative d-none d-md-block find-more-left-side">
                    ...
                    <div class="main-inner-wrapper">
                        <h2 class="heading-find-more-page mb-2">A Chief Learning Officer's Definitive 30-60-90 Day Plan
                        </h2>
                        <span class="find-more-span ">As a Chief Learning Officer, you’ve reached one of the highest
                            levels in the L&D space. You know that to succeed, you need to keep your pulse on new
                            learnings, have excellent planning skills, and be a strategic genius.</span>
                        </br>
                        </br>
                        <span class="find-more-span">Whether you're taking on a new role as a CLO or an existing one, we
                            take you through how to create a comprehensive strategy that aligns with your organization's
                            and team's objectives and targets.</span>
                ...
                <div class="col-12 col-md-5 col-lg-5 find-more-right-side">
                    <div class="sign-in-from text-center">
                        ...
                        <p class="mt-3 font-size-16">Complete the form below to have a copy of our resource sent direct
                            your inbox.</p>
                        ...
                        <form method="POST" class="mt-5" action="{{ route('login') }}" data-toggle="validator"
                            ...
                            <div class="form-group text-start">
                                ...
                                <input id="first-name" type="text" name="first_name" class="form-control mb-0"
                                    placeholder="Enter  Your  First  Name" required autofocus>
                            </div>
                            <div class="form-group text-start">
                                <h6 for="email" class="form-label fw-bold">Last Name</h6>
                                <input id="last-name" type="text" name="last_name" class="form-control mb-0"
                            ...
                            <div class="form-group text-start">
                                ...
                                <input id="company" type="text" name="company" class="form-control mb-0"
