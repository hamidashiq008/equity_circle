      ...
      <div class="container">
            <div class="row">
                    ...
                    <div class="card-body pt-0">
                        <ul class="music-lists m-0 p-0">
                            <li class="d-flex mb-4 align-items-center">
                               <div class="user-img img-fluid"><img src="{{asset('images/page-img/l1.jpg')}}" alt="story-img" class="rounded-circle avatar-40" loading="lazy"></div>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                               <div class="user-img img-fluid"><img src="{{asset('images/page-img/l2.jpg')}}" alt="story-img" class="rounded-circle avatar-40" loading="lazy"></div>
                               <div class="d-flex justify-content-between w-100">
                                  <div class="ms-3">
                            ...
                            <li class="d-flex mb-4 align-items-center">
                               <div class="user-img img-fluid"><img src="{{asset('images/page-img/l3.jpg')}}" alt="story-img" class="rounded-circle avatar-40" loading="lazy"></div>
                               <div class="d-flex justify-content-between w-100">
                                  <div class="ms-3">
                            ...
                            <li class="d-flex mb-4 align-items-center">
                               <div class="user-img img-fluid"><img src="{{asset('images/page-img/l4.jpg')}}" alt="story-img" class="rounded-circle avatar-40" loading="lazy"></div>
                               <div class="d-flex justify-content-between w-100">
                                  <div class="ms-3">
                                     <h6>Dritin</h6>
                                  </div>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                               <div class="user-img img-fluid"><img src="{{asset('images/page-img/l5.jpg')}}" alt="story-img" class="rounded-circle avatar-40" loading="lazy"></div>
                               <div class="d-flex justify-content-between w-100">
                                  <div class=" ms-3">
                                     <h6>Bones</h6>
                                  </div>
                            ...
                            <li class="d-flex align-items-center">
                               <div class="user-img img-fluid"><img src="{{asset('images/page-img/l6.jpg')}}" alt="story-img" class="rounded-circle avatar-40" loading="lazy"></div>
                               <div class="d-flex justify-content-between w-100">
                                  <div class="ms-3">
                                     <h6>Hozier</h6>
                                  </div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card-body pt-0">
                        <div class="swiper swiper-general overflow-hidden " data-slide="5" data-laptop="4" data-tab="3" data-mobile="2" data-mobile-sm="1" data-autoplay="true" data-loop="true" data-navigation="false" data-pagination="true" data-space="16">
                            <ul  class="swiper-wrapper list-inline m-0 p-0 " >
                                <li class="swiper-slide text-center">
                                    ...
                                    <div class="play-btn">
                                        ...
                                        <a href="#" class="material-symbols-outlined text-white">play_arrow</a>
                                    </div>
                                    </div>
                                    <h6>Sean Paul</h6>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card-body pt-0">
                        <div class="swiper swiper-general overflow-hidden " data-slide="5" data-laptop="4" data-tab="3" data-mobile="2"
