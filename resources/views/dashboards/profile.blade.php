{{-- <x-app-layout bodyClass="profile-page"> --}}
    <div class="container position-relative p-0">
        <div class="header-cover-img" style="background-image: url('{{ URL::asset('/images/social-banner.jpg') }}'); background-size: cover; background-repeat: no-repeat;">
        </div>
    </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-sm-12">
                                            <div id="post-modal-data"
                                                class="card card-block card-stretch  create-post-modal">
                                                <div class="card-header d-flex justify-content-between border-bottom">
                                                    <div class="header-title">
                                            ...
                                            <div class="card card-block card-stretch ">
                                                <div class="card-body">
                                                    ...
                                                    <div class="user-post mt-4">
                                                        <a data-fslightbox="gallery"
                                                            href="{{ asset('/images/abussiness(5).jpg') }}"
                                                            class="rounded">
                                                            <img src="{{ asset('/images/abussiness(5).jpg') }}"
