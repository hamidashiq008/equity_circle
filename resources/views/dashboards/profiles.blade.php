                        ...
                        <div class="row align-items-center item-header-content">
                            ...
                            <div class="col-lg-4 text-center profile-center">
                                <div class="header-avatar position-relative d-inline-block">
                                    ...
                                    <img src="{{ URL::asset('/images/profile-picture.jpg') }}" alt="user"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="event-post position-relative">
                                                        <a href="#"><img src="{{ URL::asset('/images/job-img-4.jpg') }}"
                                            ...
                                            <ul class="profile-img-gallary p-0 m-0 list-unstyled">
                                                <li class="">
                                                    <a data-fslightbox="gallery"
                                                        href="{{ URL::asset('/images/edu-card.png') }}">
                                                        <img src="{{ URL::asset('/images/edu-card.png') }}"
                                        ...
                                        <div class="card-body">
                                            <div class="row row-cols-xl-3 row-cols-md-2 row-cols-2">
                                                <div class="col mt-2 text-center">
                                                    <a href="#"><img src="{{ URL::asset('/images/job-img-1.jpg') }}"
                                                            alt="gallary-image" loading="lazy" class="img-fluid" /></a>
                                                    <h6 class="mt-2 text-center">Anna Rexia</h6>
                                                </div>
                                                <div class="col mt-2 text-center">
                                                    <a href="#"><img src="{{ URL::asset('/images/job-img-2.jpg') }}"
                                                            alt="gallary-image" loading="lazy" class="img-fluid" /></a>
                                                    <h6 class="mt-2 text-center">Tara Zona</h6>
                                                </div>
                                                <div class="col mt-2 text-center">
                                                    <a href="#"><img src="{{ URL::asset('/images/job-img-3.jpg') }}"
                                                            alt="gallary-image" loading="lazy" class="img-fluid" /></a>
                                                ...
                                                <div class="col mt-2 text-center">
                                                    <a href="#"><img src="{{ URL::asset('/images/job-img.jpg') }}"
                                                            alt="gallary-image" loading="lazy" class="img-fluid" /></a>
