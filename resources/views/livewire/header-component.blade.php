      ...
      <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar p-lg-0">
          <div class="container-fluid navbar-inner">
              <div class="d-flex align-items-center pb-2 pb-lg-0">
                  <a href="#" class="d-flex align-items-center iq-header-logo navbar-brand " style="   cursor: pointer;">
                      ...
                      <img src="{{URL::asset('/images/Equity-Circle.png')}}" class="shadowfilter" alt="" width="140">
                  </a>
              ...
              <div class="align-items-center h-100 gap-1 d-none d-xl-flex header-nav header-link-tag ">
                                  ...
                                  <div class="item-header-scroll">
                                      <a href="javascript:void(0);" class="text-body">
                                          <div class="thread d-flex justify-content-between rounded-0">
                                              <div>
                                                  <img class="avatar-45 rounded align-top"
                                                      src="{{ asset('images/store/06.jpg') }}" alt=""
                                                      loading="lazy">
                                      ...
                                      <a href="javascript:void(0);" class="text-body">
                                          <div class="thread d-flex justify-content-between rounded-0">
                                              <div>
                                                  <img class="avatar-45 rounded align-top"
                                                      src="{{ asset('images/store/02.jpg') }}" alt=""
                                                      loading="lazy">
                                                  <div class="ms-3 d-inline-block">
                                      ...
                                      <a href="javascript:void(0);" class="text-body">
                                          <div class="thread d-flex justify-content-between rounded-0">
                                              <div>
                                                  <img class="avatar-45 rounded align-top"
                                                      src="{{ asset('images/store/01.jpg') }}" alt=""
                                                      loading="lazy">
                                                  <div class="ms-3 d-inline-block">
                          ...
                          <div class="card shadow-none m-0">
                              ...
                              <div class="card-body p-0 ">
                                  ...
                                  <div class="d-flex align-items-center iq-sub-card border-0">
                                      ...
                                      <div class="ms-3">
                                          <a href="{{ route('accountsetting') }}" class="mb-0 h6"> Account settings
                                          </a>
                                      </div>
                                  </div>
                                  <div class="d-flex align-items-center iq-sub-card border-0">
                                      ...
                                      <div class="ms-3">
                                          <a href="{{ route('privacysetting') }}" class="mb-0 h6"> Privacy Settings
                                          </a>
                                      </div>
                                  </div>
...
<script>
    const headerNavBar = document.querySelector(".header-link-tag").querySelectorAll("a");
    // console.log(headerNavBar);
    headerNavBar.forEach(element => {
