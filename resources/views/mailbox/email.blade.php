                             ...
                             <div class="modal-dialog" style="max-width: 100%;">
                                <div class="modal-content">
                                   <div class="modal-header border-0 pb-0">
                                      ...
                                      <button type="submit" class="float-right close-popup text-body" data-bs-dismiss="modal"><span class="material-symbols-outlined">
                                      clear
                                      </span></button>
                                   </div>
                                         ...
                                         <div class="form-group d-flex justify-content-between align-items-center compose-bottom pt-3 m-0">
                                            <div class="d-flex flex-grow-1 align-items-center">
                                               ...
                                               <div class="send-panel">
                                                  <label class="ms-2 mb-0 bg-primary-subtle rounded" for="file"> <input type="file" id="file" style="display: none"> <a href="#" class="material-symbols-outlined writ-icon text-primary">
                                                  attachment
                                                  </a> </label>
                                                  <label class="ms-2 mb-0 bg-primary-subtle rounded"> <a href="#" class="material-symbols-outlined text-primary">
                                                  place
                                                  </a>  </label>
                                                  <label class="ms-2 mb-0 bg-primary-subtle rounded"> <a href="#" class="material-symbols-outlined text-primary">
                                                  add_to_drive
                                            ...
                                            <div class="d-flex align-items-center">
                                               <div class="send-panel float-right">
                                                  ...
                                                  <label class="ms-2 mb-0 bg-primary-subtle rounded"><a href="#" class="material-symbols-outlined">
                                                  delete
                                                  </a>  </label>
                                               </div>
                                            </div>
                    ...
                    <div class="">
                       <div class="iq-email-to-list p-3">
                          <div class="iq-email-to-list-detail d-flex justify-content-between gap-3">
                             <ul class="list-inline d-flex align-items-center justify-content-between m-0 p-0 flex-shrink-0">
                                <li class="me-1">
                                ...
                                <li class="me-1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Reload"><a href="#" class="d-flex align-items-center justify-content-center"><i class="material-symbols-outlined md-16">
                                   refresh
                                   </i></a>
                                </li>
                                <li class="me-1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Archive"><a href="#" class="d-flex align-items-center justify-content-center"><i class="material-symbols-outlined md-16">
                                   drafts
                                   </i></a>
                                </li>
                                <li class="me-1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Delete"><a href="#" class="d-flex align-items-center justify-content-center"><i class="material-symbols-outlined md-16">
                                   delete
                                   </i></a>
                                </li>
                                <li class="me-1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Inbox"><a href="#" class="d-flex align-items-center justify-content-center"><i class="material-symbols-outlined md-16">
                                   mark_email_unread
                                   </i></a>
                                </li>
                                <li data-bs-toggle="tooltip" data-bs-placement="bottom" title="Zoom"><a href="#" class="d-flex align-items-center justify-content-center"><i class="material-symbols-outlined md-16">
                                   zoom_out_map
                                   </i></a>
                                </li>
                             </ul>
                             <div class="iq-email-search d-flex flex-shrink-0">
                                ...
                                <ul class="list-inline d-flex align-items-center justify-content-between m-0 p-0">
                                   ...
                                   <li class="me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Previous"><a href="#" class="material-symbols-outlined icon-rtl">
                                      keyboard_arrow_left
                                      </a>
                                   </li>
                                   <li class="me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Next"><a href="#" class="material-symbols-outlined icon-rtl">
                                   ...
                                   <li class="iq-unread">
                                      <div class="d-flex align-self-center iq-unread-inner">
                                         <div class="iq-email-sender-info">
                                            ...
                                            <span class="material-symbols-outlined iq-star-toggle text-warning md-20">
                                            star_border
                                            </span>
                                      ...
                                      @include('components.email-app-details')
                                   </li>
                                   <li>
                                      <div class="d-flex align-self-center iq-unread-inner">
                                         <div class="iq-email-sender-info">
                                            ...
                                            <span class="material-symbols-outlined iq-star-toggle md-20">
                                            star_border
                                            </span>
