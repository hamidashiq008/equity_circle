                ...
                <div class="card card-block card-stretch card-height">
                    <div class="card-header">
                        <div class=" d-flex justify-content-between flex-wrap">
                            ...
                            <div class="dropdown">
                                <a href="javascript:void(0);" class="text-secondary dropdown-toggle"
                                    id="dropdownMenuButton223" data-bs-toggle="dropdown" aria-expanded="false">
                                    This year
                                </a>
                        ...
                        <div class="card">
                            <div class="card-body text-center">
                                <div class="d-flex align-items-center justify-content-center">
                                    <div
                                        class="border rounded bg-warning-subtle avatar-55 d-flex align-items-center justify-content-center">
                    ...
                    <div class="col-6 col-md-6 col-lg-6">
                        <div class="card">
                            <div class="card-body text-center">
                                <div class="d-flex align-items-center justify-content-center">
                                    <div
                                        class="border rounded bg-info-subtle avatar-55 d-flex align-items-center justify-content-center">
                    ...
                    <div class="col-6 col-md-6 col-lg-6">
                        <div class="card">
                            <div class="card-body text-center">
                                <div class="d-flex align-items-center justify-content-center">
                                    <div
                                        class="border rounded bg-danger-subtle avatar-55 d-flex align-items-center justify-content-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40"
                                            viewBox="0 0 640 480">
                                            <defs>
                                                <clipPath id="a">
                                            ...
                                            <g fill-rule="evenodd" stroke-width="1pt" clip-path="url(#a)"
                                                ...
                                                <circle cx="523.08" cy="344.05" r="194.93" fill="#d30000"
                    ...
                    <div class="col-6 col-md-6 col-lg-6">
                        <div class="card">
                            <div class="card-body text-center">
                                <div class="d-flex align-items-center justify-content-center">
                                    <div
                                        class="border rounded bg-success-subtle avatar-55 d-flex align-items-center justify-content-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40"
                                            viewBox="0 0 640 480">
                                            <g stroke-width="1pt">
                ...
                <div class="card card-block card-stretch card-height">
                    <div class="card-header">
                        <div class=" d-flex justify-content-between  flex-wrap">
                            ...
                            <div class="dropdown">
                                <a href="javascript:void(0);" class="text-secondary dropdown-toggle"
                                    id="dropdownMenuButton222" data-bs-toggle="dropdown" aria-expanded="false">
                                    This year
                                </a>
                    ...
                    <div class="card-body pt-0">
                        <iframe class="w-100"
                            ...
                            height="280" allowfullscreen=""></iframe>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body text-center pt-0">
                        ...
                        <p class="mb-0 mt-3 font-size-12 fw-500">58% of friends that visit your profile comment on your
                            posts.</p>
                    </div>
                </div>
            </div>
