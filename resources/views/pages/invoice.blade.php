        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            <svg width="40" class="text-primary" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-end">
                            <button type="button" class="btn btn-link mr-3"><span class="d-flex align-items-center">
