                 ...
                 <div class="sign-in-from">
                    ...
                    <form class="mt-5">
                       <div class="form-group text-start mb-0">
                          ...
                          <input type="password" class="form-control mb-0" placeholder="Your Full Name">
                       </div>
                       <button type="button" class="btn btn-primary mt-4 fw-semibold text-uppercase letter-spacing-1">log in</button>
                    </form>
                 </div>
              </div>
           </div>
