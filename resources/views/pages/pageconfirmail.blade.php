           ...
           <div class="row align-items-center">
              <div class="col-md-6 overflow-hidden position-relative">
                 ...
                 <div class="sign-in-detail container-inside-top">
                    <a href="{{route('index')}}"
                       class="d-inline-flex align-items-center justify-content-center gap-2 text-white mb-4">
                       ...
                       <h2 class="logo-title fw-semibold text-white" data-setting="app_name">SocialV</h2>
                    </a>
              ...
              <div class="col-md-6">
                 <div class="sign-in-from">
                    <img src="{{asset('images/login/mail.png')}}" width="80" alt="" class="mb-3">
                    <h1>Success !</h1>
                    <p class="mt-3 mb-0 font-size-16">A email has been send to youremail@domain.com. Please check for an email from company and click on the included link to reset your password.</p>
                    <form class="mt-4">
                       {{-- <button type="button"  class="btn btn-primary fw-semibold text-uppercase letter-spacing-1">back to home</button> --}}
                       <a href="{{route('index')}}" class="btn btn-primary fw-semibold text-uppercase letter-spacing-1">back to Home</a>
                    </form>
                 </div>
              </div>
           </div>
