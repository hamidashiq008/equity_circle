           ...
           <div class="row align-items-center">
              ...
              <div class="col-md-6">
                 <div class="sign-in-from">
                    ...
                    <p class="mt-3 font-size-16">Enter your email address and we'll send you an email with instructions to reset your password.</p>
                    <form class="mt-5">
                       <div class="form-group text-start mb-0">
                          <h6 class="form-label fw-bold">Email Address</h6>
                          <input type="email" class="form-control mb-0" placeholder="Your Full Name" value="Enter email">
                       </div>
                       <button type="button" class="btn btn-primary mt-4 fw-semibold text-uppercase letter-spacing-1">reset password</button>
                    </form>
                 </div>
              </div>
           </div>
