                 ...
                 <div class="sign-in-from text-center">
                    ...
                    <form class="mt-5">
                       <div class="form-group text-start">
                          ...
                          <input type="email" class="form-control mb-0" placeholder="Your Full Name" value="marvin">
                       </div>
                       <div class="form-group text-start">
                       ...
                       <a type="button" class="btn btn-primary mt-4 fw-semibold text-uppercase w-100" href="{{route('index')}}">sign in</a>
                       <h6 class="mt-5">Don't Have An Account ? <a href="{{route('signup')}}">Sign Up</a></h6>
                    </form>
                 </div>
              </div>
           </div>
