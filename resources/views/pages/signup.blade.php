                 ...
                 <div class="sign-in-from text-center">
                    ...
                    <form class="mt-5">
                       <div class="form-group text-start">
                          ...
                          <input type="text" class="form-control mb-0" placeholder="Your Full Name" value="marvin shaw">
                       </div>
                       <div class="form-group text-start">
                          <h6 class="form-label fw-bold">Email Address</h6>
                          <input type="email" class="form-control mb-0" placeholder="Your Full Name" value="marvin@example.com">
                       </div>
                       <div class="form-group text-start">
                          <h6 class="form-label fw-bold">Your Password</h6>
                          <input type="password" class="form-control mb-0" placeholder="Password" value="marvin">
                       </div>
                       ...
                       <button type="button" class="btn btn-primary mt-4 fw-semibold text-uppercase w-100">sign up</button>
                       <h6 class="mt-5">Already Have An Account ? <a href="{{route('signin')}}">Login</a></h6>
                    </form>
                 </div>
              </div>
           </div>
