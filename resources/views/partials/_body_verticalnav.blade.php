...
<ul class="navbar-nav iq-main-menu" id="sidebar-menu">
    ...
    <li class="nav-item">
        <a class="nav-link {{activeRoute(route('group'))}}" aria-current="page"
            href="{{route('group')}}">
            <i class="icon material-symbols-outlined">
                groups
            </i>
    ...
    <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="blog" data-bs-parent="#sidebar-menu">
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('blog.bloglist'))}}"
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('blog.blogdetail'))}}"
    ...
    <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="store" data-bs-parent="#sidebar-menu">
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('store.list'))}}"
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('store.productdetail'))}}"
                    href="{{route('store.productdetail')}}">
                    <i class="icon material-symbols-outlined filled">
                        fiber_manual_record
                    </i>
                    <i class="sidenav-mini-icon"> SD </i>
    ...
    <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="mail" data-bs-parent="#sidebar-menu">
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('mailbox.email'))}}" href="{{route('mailbox.email')}}">
                    <i class="icon material-symbols-outlined filled">
                        fiber_manual_record
                    </i>
    ...
    <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="sidebar-special" data-bs-parent="#sidebar-menu">
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('pages.pricingone'))}}"
    ...
    <li class="nav-item">
        <a class="nav-link {{activeRoute(route('adminpage'))}}" href="{{route('adminpage')}}">
            <i class="icon material-symbols-outlined">
    ...
    <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="ui-kit" data-bs-parent="#sidebar-menu">
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('ui.uialert'))}}"
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('ui.uioffcanvas'))}}"
                    href="{{route('ui.uioffcanvas')}}">
                    <i class="icon material-symbols-outlined filled">
                        fiber_manual_record
                    </i>
                    <i class="sidenav-mini-icon"> T</i>
    ...
    <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="sidebar-table" data-bs-parent="#sidebar-menu">
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('ui.datatable'))}}"
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('ui.tableedit'))}}"
    ...
    <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="sidebar-form" data-bs-parent="#sidebar-menu">
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('ui.formradio'))}}"
