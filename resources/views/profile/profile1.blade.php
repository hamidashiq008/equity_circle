<x-app-layout :isSubheader="true">
    <x-slot name="header">
        @include('components.profileheader', ['pageImage' => 'profile-bg1.jpg', 'pagetitle' => 'Profile', 'id'=>"10"])
    </x-slot>
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
                <div class="card">
                    <div class="card-body">
                        <div class="text-center">
                            <img class="img-fluid rounded-circle avatar-130" src="{{ asset('/images/user/07.jpg') }}"
                                alt="profile-img">
                            <h4 class="mt-2">John Ramsey</h4>
                            <a href="#" class="mb-3">@john_ram</a>
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between border-bottom">
                        <div class="header-title">
                            <h4 class="card-title">Profile Intro</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="ui-block-content">
                            ...
                            <div class="widget w-socials">
                                ...
                                <a href="#"
                                    class="social-item btn btn-primary d-flex align-items-center justify-content-center">
                                    <svg class="me-1" version="1.1" xmlns="http://www.w3.org/2000/svg" width="14"
                                ...
                                <a href="#"
                                    class="social-item btn btn-info d-flex align-items-center justify-content-center">
                                    <svg class="me-1" version="1.1" xmlns="http://www.w3.org/2000/svg" width="14"
                                ...
                                <a href="#"
                                    class="social-item btn btn-danger d-flex align-items-center justify-content-center">
                                    <svg class="me-1" version="1.1" xmlns="http://www.w3.org/2000/svg" width="14"
                    ...
                    <div class="col-sm-3 col-lg-6">
                        <div class="card">
                            <div class="card-body text-center">
                                <span class="material-symbols-outlined md-36 text-primary">
                                    visibility
                                </span>
                                <h6 class="mt-2  d-flex justify-content-center align-items-center">Activity</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3 col-lg-6">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <h6 class="mt-2  d-flex justify-content-center align-items-center">Moment</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3 col-lg-6 mt-1">
                        <div class="card">
                            <div class="card-body text-center">
                                <span class="material-symbols-outlined md-36 text-primary">
                                    groups
                                </span>
                                <h6 class="mt-2  d-flex justify-content-center align-items-center">Friends</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3 col-lg-6 mt-1">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <h6 class="mt-2 d-flex justify-content-center align-items-center">Edit</h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <nav class="tab-bottom-bordered">
                        <div class="mb-0 nav nav-tabs rounded-top border-0" id="nav-tab1" role="tablist">
                            <button class="nav-link border-0 active" id="nav-home-11-tab" data-bs-toggle="tab"
                                data-bs-target="#nav-home-11" type="button" role="tab" aria-controls="nav-home-11"
                                aria-selected="true">Home</button>
                            <button class="nav-link border-0" id="nav-profile-11-tab" data-bs-toggle="tab"
                                data-bs-target="#nav-profile-11" type="button" role="tab" aria-controls="nav-profile-11"
                                aria-selected="false">Profile</button>
                            <button class="nav-link border-0" id="nav-contact-11-tab" data-bs-toggle="tab"
                                data-bs-target="#nav-contact-11" type="button" role="tab" aria-controls="nav-contact-11"
                    ...
                    <div class="tab-content iq-tab-fade-up card-body" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-home-11" role="tabpanel"
                            ...
                            <div class=" borderbox1 d-flex">
                                <div class="user-img me-2">
                                    <img src="{{ asset('/images/user/1.jpg') }}" alt="userimg"
                                        class="avatar-40 rounded-circle" loading="lazy">
                                </div>
                                <div class="border rounded p-2">
                                    ...
                                    <div
                                        class=" d-flex align-items-center justify-content-between flex-wrap mb-1 gap-2">
                                        <div class="d-flex align-items-center">
                                            <h6>John Ramsey</h6>
                                            <span class=" ms-1 d-flex align-items-center">
                                                <i class="material-symbols-outlined me-2 text-primary md-16">
                                                    check_circle
                                                </i>@john_ram
                                            </span>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="mx-1"><small>35 mins</small></span>
                                        </div>
                                    </div>
                                    <h6 class="mb-2 font-size-14">very good words..</h6>
                                    <div class="border rounded  p-2">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('/images/user/02.jpg') }}" alt="userimg"
                                                    class="avatar-40 rounded-circle" loading="lazy">
                                                <div class="d-flex align-items-center">
                                                    <h6 class="ms-2">Theodocre</h6>
                                                    <p class="ms-2 mb-0">@john_ram</p>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <i class="material-symbols-outlined md-16">
                                        ...
                                        <p class="mb-0">In any moment of decsion, the best thing of you can do thing,the
                                            next best thing is the wrong thing,and the worst thing of</p>
                                    </div>
                                    <div class="d-flex flex-wrap justify-content-evenly mb-0 mt-2">
                                        <div class="d-flex align-items-center">
                                            <i class="material-symbols-outlined md-16 icon-22">
                                                chat_bubble_outline
                                            </i>
                                            <h6 class="ms-2">32</h6>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <h6 class="ms-2">426</h6>
                                        </div>
                                        <hr class="hr-vertical">
                                        <i class="material-symbols-outlined icon-rtl md-16 icon-22">
                                            shortcut
                                        </i>
                                    </div>
                                </div>
                            </div>
                            <div class="borderbox1 mt-3 rounded d-flex rounded ">
                                <div class="user-img me-2">
                                    <img src="{{ asset('/images/user/1.jpg') }}" alt="userimg"
                                        class="avatar-40 rounded-circle" loading="lazy">
                                </div>
                                <div class="borderbox border rounded p-2">
                                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                        <div class="d-flex align-items-center">
                                            <h6>John Ramsey</h6>
                                            <span class="text-primary ms-1 d-flex align-items-center">
                                                <i class="material-symbols-outlined me-2 text-primary md-16">
                                                    check_circle
                                                </i>
                                            </span>
                                            <a class=" mb-0">@john_ram</a>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <i class="material-symbols-outlined md-16">
                                                schedule
                                            </i>
                                            <span class="mx-1"><small>2 hours</small></span>
                                        </div>
                                    </div>
                                    <h6 class="font-size-14">Best views from the vactions</h6>
                                    <div class="row mt-2">
                                        <div class="col-lg-4 col-md-6 mt-1">
                                            <img src="{{ asset('/images/page-img/57.jpg') }}" class="img-fluid rounded"
                                                alt="Responsive image" loading="lazy">
                                        </div>
                                        <div class="col-lg-4 col-md-6 mt-1">
                                            <img src="{{ asset('/images/page-img/58.jpg') }}" class="img-fluid rounded"
                                                alt="Responsive image" loading="lazy">
                                        </div>
                                        <div class="col-lg-4 col-md-6 mt-1">
                                            <img src="{{ asset('/images/page-img/59.jpg') }}" class="img-fluid rounded"
                                                alt="Responsive image" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="d-flex flex-wrap justify-content-evenly mb-0 mt-2">
                            ...
                            <div class="borderbox1 mt-3 d-flex">
                                <div class="user-img me-2">
                                    <img src="{{ asset('/images/user/1.jpg') }}" alt="userimg"
                                        class="avatar-40 rounded-circle" loading="lazy">
                                </div>
                            ...
                            <div class=" borderbox1 d-flex mt-3">
                                <div class="user-img me-2">
                                    <img src="{{ asset('/images/user/1.jpg') }}" alt="userimg"
                                        class="avatar-40 rounded-circle" loading="lazy">
                                </div>
                                <div class="border rounded p-2">
                                    ...
                                    <div class="d-flex flex-wrap justify-content-evenly mb-0 mt-2">
                                        ...
                                        <hr class="hr-vertical">
                                        <div class="d-flex align-items-center">
                                            <i class="material-symbols-outlined md-16 text-danger icon-22">
                                                favorite_border
                                            </i>
                                            <h6 class="ms-2">426</h6>
                                        </div>
                        ...
                        <div class="tab-pane fade" id="nav-profile-11" role="tabpanel"
                            ...
                            <div class="card-body p-0 mb-3">
                                <div class="borderbox border p-2 rounded">
                                    <div class="d-flex  borderbox1 justify-content-between">
                                        <div class="me-3">
                                            <img src="{{asset('/images/icon/09.png')}}" class="img-fluid rounded"
                                                alt="Twitter">
                                        </div>
                                        <div class="w-100">
                                    ...
                                    <span class="mt-1">Forget the pixels for a second. Let’s focus on Tweets.Design
                                        Twitter is full of folks who Tweet well, and we want to figure out the secret to
                                        their sauce.</span>
                            ...
                            <div class="borderbox border p-2 rounded mb-3">
                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                    <div class="d-flex align-items-center">
                                        <h6>John Ramsey</h6>
                                        <span class=" ms-1 d-flex align-items-center">
                            ...
                            <div class="borderbox border p-2 rounded mb-3">
                                ...
                                <h6 class="font-size-14">Best views from the vactions</h6>
                                <div class="row mt-2">
                                    <img src="{{asset('/images/page-img/mountain.jpg')}}" alt="post-image"
                        ...
                        <div class="tab-pane fade" id="nav-contact-11" role="tabpanel"
                            ...
                            <div class=" borderbox1 d-flex mb-3">
                                <div class="user-img me-2">
                                    <img src="{{asset('/images/user/1.jpg')}}" alt="userimg"
                                        class="avatar-40 rounded-circle" loading="lazy">
                                </div>
                                <div class="borderbox border rounded p-2">
                                    ...
                                    <h6 class="mt-2 font-size-14">Best views from the vactions</h6>
                                    <div class="row mt-2">
                                        <div class="col-lg-4 col-md-6 mt-1">
                                            <img src="{{asset('images/page-img/57.jpg')}}" class="img-fluid rounded"
                                                alt="Responsive image" loading="lazy">
                            ...
                            <div class="borderbox1 d-flex mb-3">
                                ...
                                <div class="borderbox border rounded p-2">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-lg-4 col-md-6 mt-1">
                                            <img src="{{asset('/images/page-img/60.jpg')}}" class="img-fluid rounded"
                                                alt="Responsive image" loading="lazy">
                                        </div>
                                        <div class="col-lg-4 col-md-6 mt-1">
                                            <img src="{{asset('/images/page-img/61.jpg')}}" class="img-fluid rounded"
                                                alt="Responsive image" loading="lazy">
                                        </div>
                                        <div class="col-lg-4 col-md-6 mt-1">
                                            <img src="{{asset('/images/page-img/62.jpg')}}" class="img-fluid rounded"
                                                alt="Responsive image" loading="lazy">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="borderbox1 d-flex mb-3">
                                ...
                                <div class="borderbox border rounded p-2">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-lg-4 col-md-6 mt-1">
                                            <img src="{{asset('/images/page-img/63.jpg')}}" class="img-fluid rounded"
                                                alt="Responsive image">
                                        </div>
                                        <div class="col-lg-4 col-md-6 mt-1">
                                            <img src="{{asset('/images/page-img/64.jpg')}}" class="img-fluid rounded"
                                                alt="Responsive image">
                                        </div>
                                        <div class="col-lg-4 col-md-6 mt-1">
                                            <img src="{{asset('/images/page-img/65.jpg')}}" class="img-fluid rounded"
                                                alt="Responsive image">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled m-0 p-0">
                            <li class="border-bottom pb-3">
                                <a href="#" class="h5">My Perfect Vacations in South America and Europe</a>
                            ...
                            <li class="pt-3">
                                <a href="#" class="h5">The Big Experience of Travelling Alone</a>
                                <p>Lorem ipsum dolor sit amet, consect adipisicing elit, sed do eiusmod por incidid ut
                                    labore et.</p>
                                <div class="post__date">
                                    <span class="published">
                    ...
                    <div class="card-body ">
                        <div class="d-flex pb-2  border-bottom align-items-center">
                            <div class="flex-grow-1">
                                <h6>#ecommerce</h6>
                                <p class="mb-0">71.4k Tweets</p>
                            </div>
                            <div class="dropdown">
                                <span class="material-symbols-outlined" id="dropdownMenuButton9 "
                        ...
                        <div class="d-flex  pb-2  pt-2 border-bottom align-items-center">
                            <div class="flex-grow-1">
                                <h6>#apple</h6>
                                <p class="mb-0">68.2k Tweets</p>
                            </div>
                            <div class="dropdown">
                                <span class="material-symbols-outlined" id="dropdownMenuButton98"
                                    data-bs-toggle="dropdown" aria-expanded="false" role="button">
                                    expand_more
                        ...
                        <div class="d-flex  pb-2  pt-2 border-bottom align-items-center">
                            <div class="flex-grow-1">
                                <h6>#ueta</h6>
                                <p class="mb-0">63.8k Tweets</p>
                            </div>
                            <div class="dropdown">
                                <span class="material-symbols-outlined" id="dropdownMenuButton90"
                                    data-bs-toggle="dropdown" aria-expanded="false" role="button">
                                    expand_more
                        ...
                        <div class="d-flex  pb-2  pt-2 border-bottom align-items-center">
                            ...
                            <div class="dropdown">
                                <span class="material-symbols-outlined" id="dropdownMenuButton99"
                                    data-bs-toggle="dropdown" aria-expanded="false" role="button">
                                    expand_more
                        ...
                        <div class="text-center">
                            <p class="mb-0 font-weight-bold pt-3">SEE MORE</p>
                        </div>
                    </div>
                </div>
                <div class="card">
                    <div class="card-header d-flex justify-content-between border-bottom">
                        <div class="header-title">
                            <h4 class="card-title">You should follow</h4>
                        </div>
                        <i class="material-symbols-outlined icon-rtl md-16">
                            shortcut
                        </i>
                    </div>
                    <div class="card-body">
                        <ul class="list-inline m-0 p-0">
                            <li class="d-flex mb-3 align-items-center">
                                <img class="img-fluid rounded-circle avatar-40" src="{{asset('/images/user/01.jpg')}}"
                                    alt="" loading="lazy">
                                <div class="ms-2 flex-grow-1">
                                    <h6 class="d-flex align-items-center frd-name">Kate <i
                                            class="material-symbols-outlined ms-1 text-primary md-14">
                                            check_circle
                                        </i></h6>
                                    <small>@kate14</small>
                                </div>
                                <a href="#" class="btn btn-primary-subtle smallbutton">follow</a>
                            </li>
                            <li class="d-flex mb-3 align-items-center">
                                <img class="img-fluid rounded-circle avatar-40" src="{{asset('/images/user/02.jpg')}}"
                                    alt="" loading="lazy">
                                <div class="ms-2 flex-grow-1">
                                    <h6 class="d-flex align-items-center frd-name">Snman <i
                                            class="material-symbols-outlined ms-1 text-primary md-14">
                                            check_circle
                                        </i></h6>
                            ...
                            <li class="d-flex mb-3 align-items-center">
                                <img class="img-fluid rounded-circle avatar-40" src="{{asset('/images/user/03.jpg')}}"
                                    alt="" loading="lazy">
                                <div class="ms-2 flex-grow-1">
                                    <h6 class="d-flex align-items-center frd-name">Shara<i
                                            class="material-symbols-outlined ms-1 text-primary md-14">
                                            check_circle
                                        </i></h6>
