 <x-app-layout :isSubheader="true">
     <x-slot name="header">
         @include('components.profileheader', ['pageImage' => 'profile-bg3.jpg', 'pagetitle' => 'Profile 2',
         'id'=>""])
     </x-slot>
     <div class="container">
         <div class="row">
                             ...
                             <div class="col-lg-2">
                                 <div class="item1 ms-1">
                                     <img src="{{ asset('/images/user/15.jpg') }}"
                                         class="img-fluid rounded profile-image object-cover" alt="profile-image"
                                         loading="lazy">
                                 </div>
                             </div>
                             <div class="col-lg-10">
                                 <div class="d-flex justify-content-between">
                                     ...
                                     <div class="item4 ms-1">
                                         <div
                                             class="d-flex justify-content-between align-items-center ms-1 flex-wrap gap-2 gap-md-3">
                                             ...
                                             <button type="button"
                                                 class="btn btn-primary btn-sm d-flex align-items-center"><span
                                                     class="material-symbols-outlined  md-16">
                                                     add
                                                 </span>Follow</button>
                                         </div>
                                     </div>
                                 ...
                                 <div class="row">
                                     <div class="col-lg-5">
                                         <div class="item5 mt-3">
                                             <div class="d-flex align-items-center mb-1">
                                                 ...
                                                 <a href="#" class="link-primary h6 ms-2">Model at next model
                                                     management</a>
                                             </div>
                                             <div class="d-flex align-items-center mb-1">
                                                 <span class="material-symbols-outlined md-18">
                                                 ...
                                                 <span class="ms-2">Studies public relations at <a href="#"
                                                         class="link-primary h6">Cacus University</a></span>
                                             </div>
                                             <div class="d-flex align-items-center mb-5 mb-lg-1">
                                                 <span class="material-symbols-outlined md-18">
                                                     bookmark_border
                                                 </span>
                                                 <span class="ms-2"><a href="#" class="link-primary h6">Born on October
                                                         9, 2000</a></span>
                                             </div>
                                         </div>
                                     </div>
                                     <div class="col-lg-3">
                                         <div class="item6 position-relative mb-5 mb-lg-0">
                                             <div
                                                 class="vr h-100 d-inline-block position-absolute start-0 d-lg-block d-none">
                                             </div>
                                             <div
                                                 class="vr h-100 d-inline-block position-absolute end-0 d-lg-block d-none">
                                             </div>
                                             <div class="ms-2">
                                             ...
                                             <div class="iq-media-group ms-2">
                                                 <a href="#" class="iq-media">
                                                     <img class="img-fluid avatar-30 rounded-circle"
                                                 ...
                                                 <a href="#" class="iq-media">
                                                     <img class="img-fluid avatar-30 rounded-circle"
                                                         src="{{ asset('/images/user/07.jpg') }}" alt="" loading="lazy">
                                                 </a>
                                                 <a href="#" class="iq-media">
                                                     <img class="img-fluid avatar-30 rounded-circle"
                                                         src="{{ asset('/images/user/08.jpg') }}" alt="" loading="lazy">
                                                 </a>
                                             </div>
                                         </div>
                                     </div>
                                     <div class="col-lg-4">
                                         <div class="item7 ms-2">
                                             ...
                                             <div class="d-flex ">
                                                 <button type="button"
                                                     class="btn btn-sm btn-outline-secondary rounded-pill">Fashion</button>
                                                 <button type="button"
                                                     class="btn btn-sm btn-outline-secondary rounded-pill ms-1">CS</button>
                                                 <button type="button"
                                                     class="btn btn-sm btn-outline-secondary rounded-pill ms-1">Cats</button>
                                                 <button type="button"
                                                     class="btn btn-sm btn-outline-secondary rounded-pill ms-1">Politics</button>
                                             </div>
                                         </div>
                                     </div>
                                 </div>
                     ...
                     <div class="card-body">
                         ...
                         <div class="d-flex flex-column justify-content-between">
                             ...
                             <div class="d-flex align-items-center mb-1">
                                 ...
                                 <span>Studies public relations at <a href="#" class="link-primary ">Cacucasus
                                         University</a></span>
                             </div>
                             <div class="d-flex align-items-center mb-1">
                                 <span class="material-symbols-outlined md-18 me-2">
                         ...
                         <div class="d-grid gap-2 grid-cols-3">
                             <a data-fslightbox="gallery" href="{{ asset('/images/page-img/g2.jpg') }}">
                                 <img src="{{ asset('/images/page-img/g2.jpg') }}"
                                     class="img-fluid bg-info-subtle img-size" alt="photo-profile" loading="lazy">
                             </a>
                             ...
                             <a data-fslightbox="gallery" href=" {{ asset('/images/page-img/gi-7.jpg') }}">
                 ...
                 <div class="card">
                     ...
                     <div class="card-body">
                         <div class="d-grid gap-2">
                             <div class="ratio ">
                                 <iframe class="rounded embed-responsive-item"
                 ...
                 <div id="post-modal-data" class="card">
                     ...
                     <div class="card-body">
                         <div class="d-flex align-items-center">
                             <div class="user-img me-3">
                                 <img src="{{ asset('/images/user/1.jpg') }}" alt="userimg"
                                     class="avatar-60 rounded-circle" loading="lazy">
                             </div>
                             <form class="post-text w-100 " data-bs-toggle="modal" data-bs-target="#post-modal"
                                 action="#">
                         ...
                         <ul class=" post-opt-block d-flex list-inline m-0 p-0 flex-wrap gap-3">
                             <li class="bg-primary-subtle rounded p-2 pointer d-flex align-items-center"><img
                                     src="{{ asset('/images/small/07.png') }}" alt="icon" class="img-fluid me-2"
                                     loading="lazy"> Photo/Video</li>
                             <li class="bg-primary-subtle rounded p-2 pointer d-flex align-items-center"><img
                                     src="{{ asset('/images/small/08.png') }}" alt="icon" class="img-fluid me-2"
                                     loading="lazy"> Tag Friend</li>
                             <li class="bg-primary-subtle rounded p-2 pointer d-flex align-items-center"><img
                                     src="{{ asset('/images/small/09.png') }}" alt="icon" class="img-fluid me-2"
                                 ...
                                 <div class="modal-body">
                                     ...
                                     <ul class="d-flex flex-wrap align-items-center list-inline m-0 p-0">
                                         <li class="col-md-6 mb-3">
                                             <div class="bg-primary-subtle rounded p-2 pointer me-3"><a
                                                     href="#"></a><img src="{{ asset('/images/small/07.png') }}"
                                                     alt="icon" class="img-fluid" loading="lazy"> Photo/Video</div>
                                         </li>
                                         <li class="col-md-6 mb-3">
                                             <div class="bg-primary-subtle rounded p-2 pointer me-3"><a
                                                     href="#"></a><img src="{{ asset('/images/small/08.png') }}"
                                                     alt="icon" class="img-fluid" loading="lazy"> Tag Friend</div>
                                         </li>
                                         <li class="col-md-6 mb-3">
                                             <div class="bg-primary-subtle rounded p-2 pointer me-3"><a
                                                     href="#"></a><img src="{{ asset('/images/small/09.png') }}"
                                                     alt="icon" class="img-fluid" loading="lazy"> Feeling/Activity</div>
                                         </li>
                                         <li class="col-md-6 mb-3">
                                             <div class="bg-primary-subtle rounded p-2 pointer me-3"><a
                                         ...
                                         <li class="col-md-6 mb-3">
                                             <div class="bg-primary-subtle rounded p-2 pointer me-3"><a
                                                     ...
                                                     alt="icon" class="img-fluid" loading="lazy"> Live Video</div>
                                         </li>
                                         <li class="col-md-6 mb-3">
                                             <div class="bg-primary-subtle rounded p-2 pointer me-3"><a
                                         ...
                                         <li class="col-md-6 mb-3">
                                             <div class="bg-primary-subtle rounded p-2 pointer me-3"><a
                                                     ...
                                                     alt="icon" class="img-fluid" loading="lazy"> Watch Party</div>
                                         </li>
                                         <li class="col-md-6 mb-3">
                                             <div class="bg-primary-subtle rounded p-2 pointer me-3"><a
                                                     href="#"></a><img src="{{ asset('/images/small/14.png') }}"
                                                     alt="icon" class="img-fluid" loading="lazy"> Play with Friends
                                             </div>
                                         </li>
                                     </ul>
                                     <hr>
                                 ...
                                 <div class="d-flex justify-content-between">
                                     ...
                                     <div class="w-100">
                                         ...
                                         <div class="d-flex justify-content-between">
                                             ...
                                             <div class="">
                                                 <svg fill="none" width="18px" stroke="currentColor" viewBox="0 0 24 24"
                                 ...
                                 <div class="d-flex justify-content-between">
                                     ...
                                     <div class="w-100 text-margin">
                                         ...
                                         <small class=" d-flex align-items-center "> <i
                                                 class="material-symbols-outlined md-14 me-1">
                                                 schedule
                                             </i> March 14, 23:00</small>
                                         <p>Hi, I am flying to Los Angeles to attend #VSFS2020 castings. I hope it will
                                             happen and my dream comes true. Wish me luck. </p>
                                         <hr>
                                         ...
                                         <div class="d-flex align-items-center mt-3">
                                             ...
                                             <div class="comment-attagement d-flex align-items-center me-5 pe-2">
                             ...
                             <li class="mb-2">
                                 <div class="d-flex justify-content-between">
                                     ...
                                     <div class="w-100 text-margin">
                                         <h5>Mathilda Gvarliana</h5>
                                         <small class="d-flex align-items-center "><i
                                                 class="material-symbols-outlined md-16 me-1">
                                                 schedule
                                             </i> March 14, 23:00</small>
                         ...
                         <ul class="post-comments p-0 m-0">
                             <li class="mb-2">
                                 <div class="d-sm-flex justify-content-between">
                                     ...
                                     <div class="w-100 text-margin mt-sm-0 mt-2">
                                         <h5>Mathilda Gvarliana</h5>
                                         <small class="d-flex align-items-center ">
                                             <i class="material-symbols-outlined md-16 me-1">
                                                 schedule
                                             </i> March 14, 23:00</small>
                                                                 ...
                                                                 <div class="d-sm-flex justify-content-between">
                                                                     <div class="user-img me-3">
                                                                         <img src="{{asset('images/user/02.jpg')}}"
                                                                             alt="userimg"
                                                                             class="avatar-60  rounded-circle img-fluid object-cover"
                                                                             loading="lazy">
                                                                     </div>
                                                                     <div class="w-100 text-margin mt-sm-0 mt-2">
                                                                         <div class="">
                                                                             <h5 class="mb-0 d-inline-block me-1">Emma
                                                                                 Labelle</h5>
                                                                             <h6 class=" mb-0 d-inline-block">2 weeks
                                                                                 ago
                                                                             </h6>
                                                                         </div>
                                                                         ...
                                                                         <div
                                                                             ...
                                                                             <div
                                                                                 ...
                                                                                 <div
                                                                                     ...
                                                                                     <span class="card-text-1 ms-1">Love
                                                                                         it</span>
                                                                                 </div>
                                                                                 <div
                                                                                     class="d-flex align-items-center me-3">
                                                                                     ...
                                                                                     <span
                                                                                         class="card-text-1 ms-1">Comment</span>
                                                                                 </div>
                                                                                 <div class="d-flex align-items-center">
                                                                                     <span
                                                                                         class="material-symbols-outlined md-18">
                                                                                     ...
                                                                                     <span
                                                                                         class="card-text-1 ms-1">Share</span>
                                                                                 </div>
                                                                             </div>
                                                                         </div>
                                                                     </div>
                                                                     ...
                                                                     <div class="w-100 text-margin mt-sm-0 mt-2">
                                                                         ...
                                                                         <div class="d-flex align-items-center mt-3">
                                                                             <input type="text"
                                                                                 ...
                                                                                 placeholder="Write your comment">
                                                                             <div
                                                                                 class="comment-attagement d-flex align-items-center me-5 pe-2">
                                                                                 <span
                                                                                     class="material-symbols-outlined md-18 me-1">
                                                                                     comment
                                                                                 </span>
                                                                                 <h6 class="card-text-1">Comment</h6>
                                                                             </div>
                                 ...
                                 <div class="d-flex justify-content-between">
                                     ...
                                     <div class="w-100 text-margin">
                                         ...
                                         <div class="d-grid gap-2 grid-cols-2 mb-2">
                                             <a data-fslightbox="profile-gallery"
                                                 href="{{asset('images/page-img/52.jpg')}}" class="rounded">
                                                 <img src="{{asset('images/page-img/52.jpg')}}" alt="profile-image"
                                                     class="img-fluid bg-info-subtle rounded  image-size"
                                                     loading="lazy">
                                             </a>
                                             <a data-fslightbox="profile-gallery"
                                                 href="{{asset('images/page-img/53.jpg')}}" class="rounded">
                                                 <img src="{{asset('images/page-img/53.jpg')}}" alt="profile-image"
                                                     class="img-fluid bg-info-subtle rounded  image-size"
                                                     loading="lazy">
                                             </a>
                                             <a data-fslightbox="profile-gallery"
                                                 href="{{asset('images/page-img/54.jpg')}}" class="rounded">
                                                 <img src="{{asset('images/page-img/54.jpg')}}" alt="profile-image"
                                                     class="img-fluid bg-info-subtle rounded  image-size"
                                                     loading="lazy">
                                             </a>
                                             <a data-fslightbox="profile-gallery"
                                                 href="{{asset('images/page-img/55.jpg')}}" class="rounded">
                                                 <img src="{{asset('images/page-img/55.jpg')}}" alt="profile-image"
                                                     class="img-fluid bg-info-subtle rounded  image-size"
                                                     loading="lazy">
                                             </a>
                                         </div>
