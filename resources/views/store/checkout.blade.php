<x-app-layout :isSubheader="true" activelink='store'>
    <x-slot name="header">
        @include('components.profileheader', ['pageImage' => 'profile-bg7.jpg', 'pagetitle' => 'Store Checkout',
        'id'=>"05"])
    </x-slot>
    <div class="container">
        <div class="row">
                          ...
                          <div class="checkout-product">
                             <div class="row align-items-center">
                                <div class="col-sm-2">
                                   ...
                                   <a href="#"><img class="img-fluid rounded" src="{{asset('images/store/01.jpg')}}" alt=""  loading="lazy"></a>
                                   </span>
                                </div>
                                <div class="col-sm-4">
                                         ...
                                         <div class="row align-items-center ">
                                            <div class="col-sm-7 col-md-6 col-8">
                                               <div class="quantity buttons_added">
                                                  <input type="button" value="-" class="minus me-1">
                                                  <input type="number" step="1" min="1" max="100" name="quantity" value="1" title="Qty" class="input-text qty text"  disabled ><input type="button" value="+" class="plus ms-1">
                                               </div>
                                            </div>
                                            <div class="col-sm-5 col-md-6 col-4">
                                               <span class="product-price mx-2">$15</span>
                                            </div>
                                         </div>
                                      </div>
                                      <div class="col-sm-2 col-2">
                                         <a href="#" class="text-dark material-symbols-outlined">delete</a>
                                      </div>
                                   </div>
                                </div>
                             </div>
                       ...
                       <div class="card-body">
                          <div class="checkout-product">
                             <div class="row align-items-center">
                                <div class="col-sm-2">
                                   <span class="checkout-product-img">
                                   <a href="#"><img class="img-fluid rounded" src="{{asset('images/store/02.jpg')}}" alt=""  loading="lazy"></a>
                                   </span>
                                </div>
                                <div class="col-sm-4">
                                   <div class="checkout-product-details">
                                   ...
                                   <div class="row">
                                      <div class="col-sm-10 col-10">
                                         <div class="row align-items-center ">
                                            ...
                                            <div class="col-sm-5 col-md-6 col-4">
                                               <span class="product-price mx-2">$25</span>
                                            </div>
                                         </div>
                                      </div>
                                      <div class="col-sm-2 col-2">
                       ...
                       <div class="card-body">
                          <div class="checkout-product">
                             <div class="row align-items-center">
                                <div class="col-sm-2">
                                   <span class="checkout-product-img">
                                   <a href="#"><img class="img-fluid rounded" src="{{asset('images/store/03.jpg')}}" alt=""  loading="lazy"></a>
                                   </span>
                                </div>
                                <div class="col-sm-4">
                                   <div class="checkout-product-details">
                                   ...
                                   <div class="row">
                                      <div class="col-sm-10 col-10">
                                         <div class="row align-items-center ">
                                            ...
                                            <div class="col-sm-5 col-md-6 col-4">
                                               <span class="product-price mx-2">$18</span>
                                            </div>
                                         </div>
                                      </div>
                                      <div class="col-sm-2 col-2">
                       ...
                       <div class="card-body">
                          <div class="checkout-product">
                             <div class="row align-items-center">
                                <div class="col-sm-2">
                                   <span class="checkout-product-img">
                                   <a href="#"><img class="img-fluid rounded" src="{{asset('images/store/04.jpg')}}" alt=""  loading="lazy"></a>
                                   </span>
                                </div>
                                <div class="col-sm-4">
                                   <div class="checkout-product-details">
                                   ...
                                   <div class="row">
                                      <div class="col-sm-10 col-10">
                                         <div class="row align-items-center ">
                                            ...
                                            <div class="col-sm-5 col-md-6 col-4">
                                               <span class="product-price mx-2">$28</span>
                                            </div>
                                         </div>
                                      </div>
                                      <div class="col-sm-2 col-2">
                 ...
                 <div class="col-lg-4">
                    ...
                    <div class="card ">
                       <div class="card-body card-body p-0 iq-checkout-policy">
                          <ul class="p-0 m-0">
                             <li class="d-flex align-items-center p-3 gap-2 gap-md-3">
                 ...
                 <div class="col-lg-8">
                    <div class="card">
                       ...
                       <div class="card-body">
                          ...
                          <hr>
                          <div class="add-card">
                             <a href="#"><span class="d-flex align-items-center"><i class="material-symbols-outlined me-1">add_box</i>Add Gift Card</span></a>
                          </div>
                       </div>
                    </div>
                 </div>
