<x-app-layout :isSubheader="true" activelink='store'>
         <x-slot name="header">
            @include('components.profileheader', ['pageImage' => 'profile-bg7.jpg', 'pagetitle' => 'Store Category',
            'id'=>"05"])
        </x-slot>
                     ...
                     <div class="card-body pt-0">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                           <div class="form-check d-flex align-items-center">
                              ...
                              <label for="radio1" class="form-check-label mb-0 ps-2"><b>All Reviews</b></label>
                           </div>
