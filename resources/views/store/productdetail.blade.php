<x-app-layout activelink='store'>
    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        <div class="product-vertical-slider">
                            <div class="slider__flex">
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <div class="slider__image">
                                                        <img src="{{asset('images/store/product-detail/01.jpg')}}"
                                                            alt="" loading="lazy" />
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="slider__image">
                                                        <img src="{{asset('images/store/product-detail/02.jpg')}}"
                                                            alt="" loading="lazy" />
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="slider__image">
                                                        <img src="{{asset('images/store/product-detail/3.jpg')}}" alt=""
                                                            loading="lazy" />
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="slider__image">
                                                        <img src="{{asset('images/store/product-detail/04.jpg')}}"
                                                            alt="" loading="lazy" />
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="slider__image">
                                                        <img src="{{asset('images/store/product-detail/05.jpg')}}"
                                                            alt="" loading="lazy" />
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="slider__image">
                                                        <img src="{{asset('images/store/product-detail/06.jpg')}}"
                                                            alt="" loading="lazy" />
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="slider__images bg-light-subtle">
                                    <div class="swiper swiper-container">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="slider__image">
                                                    <img src="{{asset('images/store/product-detail/01.jpg')}}" alt=""
                                                        loading="lazy" />
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="slider__image">
                                                    <img src="{{asset('images/store/product-detail/02.jpg')}}" alt=""
                                                        loading="lazy" />
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="slider__image">
                                                    <img src="{{asset('images/store/product-detail/04.jpg')}}" alt=""
                                                        loading="lazy" />
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="slider__image">
                                                    <img src="{{asset('images/store/product-detail/05.jpg')}}" alt=""
                                                        loading="lazy" />
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="slider__image">
                                                    <img src="{{asset('images/store/product-detail/06.jpg')}}" alt=""
                                                        loading="lazy" />
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-5">
                        <div class="border-bottom pb-3 mb-3 pt-5 pt-lg-0">
                            <div class="d-flex flex-column align-content-between justify-items-center mb-2">
                                <div class="d-flex justify-content-between">
                                    <h3 class="mb-0 fw-semibold">Leather Bags</h3>
                                    <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#share-btn2"
                                        aria-controls="share-btn">
                                        <span
                                            class="material-symbols-outlined align-text-top font-size-20 bg-light-subtle text-dark rounded p-2">share</span>
                                    </a>
                                </div>
                                <div class=" d-flex align-items-center w-100">
                                    ...
                                    <span class="ms-1 font-size-14 fw-semibold text-capitalize">(4 customer
                                        review)</span>
                                </div>
                            </div>
                            <h4 class="fw-semibold font-size-18 mb-3">$49.99</h4>
                            <p class="text-body fw-semibold text-capitalize mb-0">availability: <span
                                    class="text-success">in stock</span></p>
                        </div>
                        <div class="border-bottom pb-4 mb-4">
                            <h6 class="fw-semibold mb-2">Size:</h6>
                            <div class="d-flex mb-4">
                                <a href="#" class="product-size active">S</a>
                                <a href="#" class="product-size">M</a>
                                <a href="#" class="product-size">L</a>
                                <a href="#" class="product-size">XL</a>
                                <a href="#" class="product-size">XXL</a>
                            </div>
                            <h6 class="fw-semibold mb-2">Color:<span class="ms-1 fw-normal">Green</span></h6>
                            <ul class="d-flex list-inline mb-4">
                                <li class="border rounded-circle me-3"><a href="#"
                                        class="product-color bg-secondary"></a></li>
                                <li class="border rounded-circle me-3"><a href="#" class="product-color bg-primary"></a>
                                </li>
                                <li class="border rounded-circle me-3"><a href="#" class="product-color bg-success"></a>
                                </li>
                                <li class="border rounded-circle me-3"><a href="#" class="product-color bg-danger"></a>
                                </li>
                                <li class="border rounded-circle me-3"><a href="#" class="product-color bg-warning"></a>
                                </li>
                            </ul>
                            <div class="d-flex align-items-center gap-3">
                                 <div class="btn-group iq-qty-btn" data-qty="btn" role="group">
                             <button type="button" class="btn btn-outline-light iq-quantity-minus text-dark">
                             ...
                             <input type="text" class="btn btn-outline-light input-display"
                                data-qty="input" pattern="^(0|[1-9][0-9]*)$" minlength="1" maxlength="2"
                                value="2" title="Qty" >
                             <button type="button" class="btn btn-outline-light iq-quantity-plus text-dark">
                                ...
                                <button type="button" class="btn btn-primary fw-semibold font-size-14 w-50">Add to
                                    cart</button>
                            </div>
                        </div>
                        <div class="d-flex flex-wrap gap-3 mt-4">
                            <a href="#"
                                class="d-flex align-items-center gap-1 font-size-14 fw-semibold text-body text-capitalize">
                            ...
                            <a href="#"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                    fill="none">
                                    <path d="M2.5 2.5V17.5H17.5" stroke="#2B2D42" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M15 14.1667V7.5" stroke="#2B2D42" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M10.833 14.1667V4.16666" stroke="#2B2D42" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M6.66699 14.1667V11.6667" stroke="#2B2D42" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                ...
                <div class="row mt-5 pt-4">
                    <div class="col-lg-12">
                        <div class="product-detail-tabs">
                            <ul class="nav nav-tabs justify-content-center gap-4 mb-3 gap-lg-5 border-bottom"
                                id="product-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a href="javascript:void(0)"
                                        class="nav-link active bg-transparent px-0 py-2 fs-5 rounded-0"
                                        data-bs-toggle="tab" data-bs-target="#description" role="tab"
                                        aria-selected="true">Description</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a href="javascript:void(0)"
                                        class="nav-link bg-transparent px-0 py-2 fs-5 rounded-0" data-bs-toggle="tab"
                                ...
                                <li class="nav-item" role="presentation">
                                    <a href="javascript:void(0)"
                                        class="nav-link bg-transparent px-0 py-2 fs-5 rounded-0" data-bs-toggle="tab"
                                        data-bs-target="#reviews" role="tab" aria-selected="false">Reviews(2)</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a href="javascript:void(0)"
                                        class="nav-link bg-transparent px-0 py-2 fs-5 rounded-0" data-bs-toggle="tab"
                                        data-bs-target="#storedetail" role="tab" aria-selected="false">Store Detail</a>
                                </li>
                            </ul>
                            <div class="tab-content" id="product-tab-content">
                                <div class="tab-pane fade show active" id="description" role="tabpanel">
                                    <p class="m-0">There are many variations of passages of Lorem Ipsum available,
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered mb-0">
                                            <tbody>
                                                ...
                                                <tr class="text-body">
                                                    <th class="fw-semibold">Ideal For</th>
                                                    <td>Men & Women</td>
                                                </tr>
                                                <tr class="text-body">
                                                    <th class="fw-semibold">Trolley Support</th>
                                                    <td>No</td>
                                                </tr>
                                                <tr class="text-body">
                                                    <th class="fw-semibold">Laptop Sleeve</th>
                                                    <td>No</td>
                                                </tr>
                                                <tr class="text-body">
                                                    <th class="fw-semibold">With Rain Cover</th>
                                                    <td>No</td>
                                                </tr>
                                                <tr class="text-body">
                                                    <th class="fw-semibold">Style Code</th>
                                                    <td>Provogue_Day_002</td>
                                                </tr>
                                                <tr class="text-body">
                                                    <th class="fw-semibold">Color Code</th>
                                                    <td>Grey, Black</td>
                                                </tr>
                                                <tr class="text-body">
                                                    <th class="fw-semibold">Material, Waterproof</th>
                                                    <td>Material: Polyester, Waterproof: Yes</td>
                                                </tr>
                                                <tr class="text-body">
                                                    <th class="fw-semibold">Number of Compartments</th>
                                                    <td>2</td>
                                                </tr>
                                                <tr class="text-body">
                                                    <th class="fw-semibold">Self Design</th>
                                                    <td>No</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="product-review-list">
                                        <ul class="list-inline m-0 p-0">
                                                ...
                                                <div class="d-flex flex-sm-row flex-column gap-3">
                                                    <div class="user-image flex-shrink-0">
                                                        <img src="{{asset('images/page-img/19.jpg')}}"
                                                            class="avatar-120" alt="" loading="lazy" />
                                                    </div>
                                                    <div class="about-user">
                                                        <div
                                                            class="d-flex justify-content-between align-items-center my-2 my-lg-0">
                                                            <h6 class="mb-0 fw-500">Jackson Jones</h6>
                                                            <a class="text-dark " href="javascript:void(0)">Reply</a>
                                                        </div>
                                                        <small href="#" class="text-primary">March 01st 2021</small>
                                                        <p class="mt-1 mb-0">Lorem ipsum dolor sit amet, consectetur
                                                            adipiscing elit. Aliquam ut eu morbi tincidunt erat egestas
                                                            quisque ultrices ut. Vel elementum blandit et tellus sit
                                                            tincidunt.</p>
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="p-4 border rounded">
                                                <div class="d-flex flex-sm-row flex-column gap-3">
                                                    <div class="user-image flex-shrink-0">
                                                        <img src="{{asset('images/page-img/22.jpg')}}"
                                                            class="avatar-120" alt="" loading="lazy" />
                                                    </div>
                                                    <div class="about-user">
                                                        <div
                                                            class="d-flex justify-content-between align-items-center my-2 my-lg-0">
                                                            <h6 class="mb-0 fw-500">Emma Jones</h6>
                                                            <a class="text-dark " href="javascript:void(0)">Reply</a>
                                                        </div>
                                                        <small href="#" class="text-primary">March 20th 2021</small>
                                                        <p class="mt-1">Lorem ipsum dolor sit amet, consectetur
                                                            adipiscing elit. Aliquam ut eu morbi tincidunt erat egestas
                                                            quisque ultrices ut. Vel elementum blandit et tellus sit
                                                            tincidunt.</p>
                                                        <div class="d-flex mb-3">
                                                            <a class="" href="javascript:void(0)">Reply To Jackson
                                                                Jones</a>
                                                            <a class="text-body ms-3" href="javascript:void(0)">Cancel
                                                                Reply</a>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <button type="submit"
                                                                class="btn btn-primary rounded mt-3">Get
                                                                Started</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="5" id="message"
                                                        aria-label="With textarea" spellcheck="false"
                                ...
                                <div class="tab-pane fade" id="storedetail" role="tabpanel">
                                    <div class="d-flex align-items-center gap-3">
                                        <img src="{{asset('images/store/product-detail/store.png')}}" alt=""
                                            loading="lazy" />
                                        <div>
                                            <h5 class="text capitalize fw-semibold">voltt scale store</h5>
                                    ...
                                    <div class="table-responsive store-detail-table">
                                        <table class="mt-5 pt-2">
                                            <tr>
                                                <th class="w-25">
                                                    <h6 class="text-capitalize fw-semibold">address:</h6>
                                                </th>
                                                <td class="w-75">492 Devon StreetMissoula, MT 59801, united states</td>
                                            </tr>
                                            <tr>
                                                <th class="w-25">
                                                    <h6 class="text-capitalize fw-semibold">time:</h6>
                                                </th>
                                                <td class="w-75">
                                                    <h6 class="text-capitalize fw-normal mb-2">mon to fri:<span
                                                            class="text-body ms-2">08:00 AM - 16:00 PM</span></h6>
                                                    <h6 class="text-capitalize fw-normal">Weekends:<span
                                                            class="text-body ms-2">Closed</span></h6>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th class="w-25">
                                                    <h6 class="text-capitalize fw-semibold">number:</h6>
                                                </th>
                                                <td class="w-75 text-primary">(+16) 813 021 021</td>
                                            </tr>
                                            <tr>
                                                <th class="w-25">
                                                    <h6 class="text-capitalize fw-semibold">Follow Us:</h6>
                                                </th>
                                                <td class="w-75">
                                                    <ul class="list-inline d-flex align-items-center gap-2 mb-0">
                                                        <li>
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="32"
                                                                ...
                                                                <path
                                                                    ...
                                                                    fill="white" />
                                                                <defs>
                                                                    <linearGradient id="paint0_linear_963_723" x1="16"
                                                                        y1="27.1693" x2="16" y2="4"
                                                        ...
                                                        <li>
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="32"
                                                                ...
                                                                <defs>
                                                                    <radialGradient id="paint0_radial_963_724" cx="0"
                                                                    ...
                                                                    <radialGradient id="paint1_radial_963_724" cx="0"
                                                                        cy="0" r="1" gradientUnits="userSpaceOnUse"
        ...
        <div class="swiper swiper-general overflow-hidden " data-slide="3" data-laptop="2" data-tab="2" data-mobile="1"
                    ...
                    <div class="card card-block card-stretch card-height product">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between pb-3">
                                <div class="d-flex align-items-center">
                                    <img class="img-fluid rounded-circle avatar-30"
                                        src="{{asset('images/user/01.jpg')}}" alt="" loading="lazy">
                            ...
                            <div class="image-block position-relative">
                                <img src="{{asset('images/store/01.jpg')}}" class="img-fluid w-100 rounded"
                    ...
                    <div class="card card-block card-stretch card-height product">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between pb-3">
                                <div class="d-flex align-items-center">
                                    <img class="img-fluid rounded-circle avatar-30"
                                        src="{{asset('images/user/02.jpg')}}" alt="" loading="lazy">
                                    <div class="media-body ms-2">
                                        <p class="mb-0 line-height">Posted By</p>
                                        <h6><a href="#">Paul Molive</a></h6>
                                    </div>
                            ...
                            <div class="image-block position-relative">
                                <img src="{{asset('images/store/02.jpg')}}" class="img-fluid w-100 rounded"
                                    alt="product-img" loading="lazy">
                                <div class="offer">
                                    <div class="offer-title">30%</div>
                                </div>
                    ...
                    <div class="card card-block card-stretch card-height product">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between pb-3">
                                <div class="d-flex align-items-center">
                                    <img class="img-fluid rounded-circle avatar-30"
                                        src="{{asset('images/user/03.jpg')}}" alt="" loading="lazy">
                                    <div class="media-body ms-2">
                                        <p class="mb-0 line-height">Posted By</p>
                            ...
                            <div class="image-block position-relative">
                                <img src="{{asset('images/store/03.jpg')}}" class="img-fluid w-100 rounded"
                                    alt="product-img" loading="lazy">
                    ...
                    <div class="card card-block card-stretch card-height product">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between pb-3">
                                <div class="d-flex align-items-center">
                                    <img class="img-fluid rounded-circle avatar-30"
                                        src="{{asset('images/user/04.jpg')}}" alt="" loading="lazy">
                                    <div class="media-body ms-2">
                                        <p class="mb-0 line-height">Posted By</p>
                            ...
                            <div class="image-block position-relative">
                                <img src="{{asset('images/store/04.jpg')}}" class="img-fluid w-100 rounded"
                                    alt="product-img">
                                <div class="offer">
                                    <div class="offer-title">30%</div>
                                </div>
                    ...
                    <div class="card card-block card-stretch card-height product">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between pb-3">
                                <div class="d-flex align-items-center">
                                    <img class="img-fluid rounded-circle avatar-30"
                                        src="{{asset('images/user/05.jpg')}}" alt="" loading="lazy">
                                    <div class="media-body ms-2">
                                        <p class="mb-0 line-height">Posted By</p>
                            ...
                            <div class="image-block position-relative">
                                <img src="{{asset('images/store/05.jpg')}}" class="img-fluid w-100 rounded"
                                    alt="product-img" loading="lazy">
                                <div class="offer">
                    ...
                    <div class="card card-block card-stretch card-height product">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between pb-3">
                                <div class="d-flex align-items-center">
                                    <img class="img-fluid rounded-circle avatar-30"
                                        src="{{asset('images/user/06.jpg')}}" alt="" loading="lazy">
                                    <div class="media-body ms-2">
                                        <p class="mb-0 line-height">Posted By</p>
                            ...
                            <div class="image-block position-relative">
                                <img src="{{asset('images/store/06.jpg')}}" class="img-fluid w-100 rounded"
                                    alt="product-img" loading="lazy">
                                <div class="offer">
