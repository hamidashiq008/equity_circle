                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-md-12 p-0">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 form-group">
                                                    <label for="acno" class="form-label">Alternate Contact Number:
                                                        *</label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 form-group">
                                                    <div class="form-group">
                                                        <label for="ccno" class="form-label">Contact Number:
                                                            *</label>
                                                ...
                                                <div class="col-md-6 form-group">
                                                    <div class="form-group">
                                                        <label for="cemail" class="form-label">Company Mail Id:
                                                            *</label>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="cadd" class="form-label">Company Address:
                                                            *</label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-md-12 p-0">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 form-group">
                                                    <label for="accname" class="form-label">Account Holder Name:
                                                        *</label>
                                                ...
                                                <div class="col-md-6 form-group">
                                                    <label for="branch" class="form-label">Bank Branch Name:
                                                        *</label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-md-12 p-0">
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-3"> <img src="{{ asset('/images/page-img/img-success.png') }}" class="img-fluid" alt="img-success" loading="lazy"> </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
