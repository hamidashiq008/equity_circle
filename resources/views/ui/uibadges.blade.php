        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <p>Badges can be used as part of buttons to provide a counter.</p>
                        <button type="button" class="btn mb-1 btn-primary-subtle">
                            Notifications <span class="badge bg-primary ml-2">4</span>
                        </button>
                        <button type="button" class="btn mb-1 btn-success-subtle">
                            Notifications <span class="badge bg-success ml-2">4</span>
                        </button>
                        <button type="button" class="btn mb-1 btn-danger-subtle">
                            Notifications <span class="badge bg-danger ml-2">4</span>
                        </button>
                    </div>
                </div>
            ...
            <div class="col-sm-12 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <p class="mb-0">Add any of the below mentioned modifier classes to change the appearance of a
                            badge.</p>
                        ...
                        <p class="mb-0">Use the <code>.badge-pill</code> modifier class to make badges more rounded
                            (with a larger <code>border-radius</code> and additional horizontal <code>padding</code>).
                        ...
                        <p class="mb-0">Using the contextual <code>.badge-*</code> classes on an <code>&lt;a&gt;</code>
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <p class="mb-0">Use the <code>.badge-pill</code> modifier class to make badges more rounded
                            (with a larger <code>border-radius</code> and additional horizontal <code>padding</code>).
                            Useful if you miss the badges from v3.</p>
                        <span class="badge rounded-pill border border-primary text-primary mt-2">Primary</span>
                        <span class="badge rounded-pill border border-secondary text-secondary mt-2">Secondary</span>
                        <span class="badge rounded-pill border border-success text-success mt-2">Success</span>
                        <span class="badge rounded-pill border border-danger text-danger mt-2">Danger</span>
                        <span class="badge rounded-pill border border-warning text-warning mt-2 ">Warning</span>
                        <span class="badge rounded-pill border border-info text-info mt-2">Info</span>
                        <span class="badge rounded-pill border border-light text-light mt-2">Light</span>
                        <span class="badge rounded-pill border border-dark text-dark mt-2">Dark</span>
                        <h5 class="card-title mt-4">Links</h5>
                        <p class="mb-0">Using the contextual <code>.badge-*</code> classes on an <code>&lt;a&gt;</code>
                            element quickly provide <em>actionable</em> badges with hover and focus states.</p>
