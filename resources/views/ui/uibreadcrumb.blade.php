        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <p>Use the items in order to programatically generate the breadcrumb links.use class
                            <code>.breadcrumb to ol</code> with Icon</p>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb bg-primary-subtle">
                                <li class="breadcrumb-item active d-flex" aria-current="page"><i
                                        class="material-symbols-outlined me-1">home</i>Home</li>
                            </ol>
                        </nav>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb bg-primary-subtle">
                                <li class="breadcrumb-item"><a href="#"><i
                                            class="material-symbols-outlined me-1">home</i></li>
                                <li class="breadcrumb-item active" aria-current="page">Library</li>
                            </ol>
                        </nav>
                        <nav aria-label="breadcrumb">
            ...
            <div class="col-sm-12 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb bg-primary">
                                <li class="d-flex breadcrumb-item active text-white" aria-current="page"><i
                                        class="material-symbols-outlined me-1">home</i>Home</li>
                            </ol>
                        </nav>
                        <nav aria-label="breadcrumb">
            ...
            <div class="col-sm-12 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb bg-primary-subtle">
                                <li class="d-flex breadcrumb-item active" aria-current="page"><i
                                        class="material-symbols-outlined me-1">home</i>Home</li>
                            </ol>
                        </nav>
                        <nav aria-label="breadcrumb">
            ...
            <div class="col-sm-12 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <nav aria-label="breadcrumb bg-danger-subtle">
