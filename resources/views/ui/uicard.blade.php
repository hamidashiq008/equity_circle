<x-app-layout>
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <div class="card position-relative inner-page-bg bg-primary" style="height: 150px;">
                    <div class="inner-page-title">
                        <h3 class="text-white">Card Page</h3>
            ...
            <div class="col-sm-3">
                <div class="card mb-3">
                    <img src="{{ asset('/images/page-img/07.jpg') }}" class=" card-img-top" alt="#" loading="lazy">
                    <div class="card-body">
            ...
            <div class="col-sm-3">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">It is a long established fact that a reader will be distracted by the
                            readable content of a page when looking at its layout. </p>
                        <p>It is a long established fact that a the readable content of a page when looking at its
                            layout.</p>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="card bg-dark text-white mb-3">
                    <img src="{{ asset('/images/page-img/07.jpg') }}" class=" card-img" alt="#" loading="lazy">
            ...
            <div class="col-lg-6">
                <div class="card mb-3">
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <img src="{{ asset('/images/page-img/08.jpg') }}" class="card-img" alt="#" loading="lazy">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                <h4 class="card-title">Card title</h4>
            ...
            <div class="col-lg-6">
                <div class="card mb-3">
                    <div class="row no-gutters flex-row-reverse">
                        <div class="col-md-4">
                            <img src="{{ asset('/images/page-img/09.jpg') }}" class="card-img" alt="#" loading="lazy">
                        </div>
                        <div class="col-md-8">
            ...
            <div class="col-lg-4">
                <div class="card mb-3 border-primary">
                    <div class="card-body text-primary">
                        ...
                        <p class="card-text">Some quick example text to build on the card title text to build on the
