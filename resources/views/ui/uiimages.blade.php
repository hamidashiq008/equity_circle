        ...
        <div class="row">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="d-flex">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('/images/page-img/16.jpg') }}" class="img-fluid avatar-70 me-3"
                                    alt="#">
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <p>Change the order of content in media objects by modifying the HTML itself, or by adding some
                            custom flexbox CSS to set the <code>order</code> property (to an integer of your choosing).
                        </p>
                        ...
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <img src="{{ asset('/images/page-img/19.jpg') }}"
                                class="align-self-center ms-3 img-fluid avatar-70" alt="#">
                        </div>
                        <div class="d-flex align-items-center">
                            <div class="">
                            ...
                            <img src="{{ asset('/images/page-img/20.jpg') }}"
                                class="align-self-end ms-3 img-fluid avatar-70" alt="#">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <p>In addition to our <a href="/#">border-radius utilities</a>, you
                            can use <code>.img-thumbnail</code> to give an image a rounded 1px border appearance.</p>
                        ...
                        <img src="{{ asset('/images/page-img/12.jpg') }}" class="rounded-circle ms-3 mt-3"
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <p>The images or other media can be aligned top, middle, or bottom. The default is top aligned.
                        </p>
                        <div class="d-flex align-items-center mb-4">
                            <img src="{{ asset('/images/page-img/21.jpg') }}"
                                class="align-self-start me-3 img-fluid avatar-70" alt="#">
                            <div class="">
                        ...
                        <div class="d-flex align-items-center mb-4">
                            <img src="{{ asset('/images/page-img/22.jpg') }}"
                                class="align-self-center me-3 img-fluid avatar-70" alt="#">
                            <div class="">
                        ...
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('/images/page-img/23.jpg') }}"
                                class="align-self-end me-3 img-fluid avatar-70" alt="#">
                            <div class="">
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <p>Because the media object has so few structural requirements, you can also use these classes
                            on list HTML elements. On your <code>&lt;ul&gt;</code> or <code>&lt;ol&gt;</code>, add the
                        ...
                        <ul class="list-unstyled">
                            <li class="d-flex align-items-center">
                                <img src="{{ asset('/images/page-img/24.jpg') }}" class="me-3 img-fluid avatar-70"
                                    alt="#">
                                <div class="">
                            ...
                            <li class="d-flex align-items-center my-4">
                                <img src="{{ asset('/images/page-img/15.jpg') }}" class="me-3 img-fluid avatar-70"
                                    alt="#">
                                <div class="">
                                    <h5 class="mt-0 mb-1">List-based media object</h5>
                                    Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante
                            ...
                            <li class="d-flex align-items-center">
                                <img src="{{ asset('/images/page-img/16.jpg') }}" class="me-3 img-fluid avatar-70"
                                    alt="#">
                                <div class="">
                                    <h5 class="mt-0 mb-1">List-based media object</h5>
                                    Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante
