      ...
      <div class="row">
         <div class="col-sm-12">
            <div class="card position-relative inner-page-bg bg-primary" style="height: 150px;">
               <div class="inner-page-title">
                  <h3 class="text-white">List Group Page</h3>
         ...
         <div class="col-sm-12 col-lg-6">
            <div class="card">
               ...
               <div class="card-body pt-0">
                  <p>The most basic list group is an unordered list with list items and the proper classes. Build
                     upon it with the options that follow, or with your own CSS as needed.</p>
                  <ul class="list-group">
            ...
            <div class="card">
               ...
               <div class="card-body pt-0">
                  <p>Add <code>.disabled</code> to a <code>.list-group-item</code> to make it <em>appear</em>
                     ...
                     JavaScript to fully disable their click events (e.g., links).</p>
                  <ul class="list-group">
            ...
            <div class="card">
               ...
               <div class="card-body pt-0">
                  <p>Add <code class="highlighter-rouge">.list-group-flush</code> to remove some borders and
            ...
            <div class="card">
               ...
               <div class="card-body pt-0">
                  <p>Add badges to any list group item to show unread counts, activity, and more with the help of
                     some <a href="/docs/4.3/utilities/flex/">utilities</a>.</p>
                  <ul class="list-group">
         ...
         <div class="col-sm-12 col-lg-6">
            <div class="card">
               ...
               <div class="card-body pt-0">
                  <p>Add <code>.active</code> to a <code>.list-group-item</code> to indicate the current active
                     selection.</p>
                  <ul class="list-group">
                     <li class="list-group-item bg-primary">Cras justo odio</li>
                     <li class="list-group-item">Dapibus ac facilisis in</li>
                     <li class="list-group-item">Morbi leo risus</li>
                     <li class="list-group-item">Porta ac consectetur ac</li>
                     <li class="list-group-item">Vestibulum at eros</li>
            ...
            <div class="card">
               ...
               <div class="card-body pt-0">
                  <p>Use <code>&lt;a&gt;</code>s or <code>&lt;button&gt;</code>s to create <em>actionable</em>
                     list group items with hover, disabled, and active states by adding
                     <code>.list-group-item-action</code>. We separate these pseudo-classes to ensure list groups
                     made of non-interactive elements (like <code>&lt;li&gt;</code>s or
            ...
            <div class="card">
               ...
               <div class="card-body pt-0">
                  <p>Add <code>.list-group-horizontal</code> to change the layout of list group items from
                     ...
                     <code>.list-group-horizontal-{sm|md|lg|xl}</code> to make a list group horizontal starting
                     at that breakpoint’s <code>min-width</code>. Currently <strong>horizontal list groups cannot
                        be combined with flush list groups.</strong>
                  </p>
