        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <p>Toasts are as flexible as you need and have very little required markup. At a minimum, we
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <p>When you have multiple toasts, we default to vertically stacking them in a readable manner.
                        </p>
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <p>Toasts are slightly translucent, too, so they blend over whatever they might appear over. For
                            browsers that support the <code>backdrop-filter</code> CSS property, we’ll also attempt to
                            blur the elements under a toast.</p>
                        <div class="p-3 bg-dark">
                            <div class="toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
                                <div class="toast-header">
                                    <svg class="bd-placeholder-img rounded me-2" width="20" height="20"
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <p>Place toasts with custom CSS as you need them. The top right is often used for notifications,
                        ...
                        <p class="mt-3">For systems that generate more notifications, consider using a wrapping element
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <p>Toasts are as flexible as you need and have very little required markup. At a minimum, we
                            require a single element to contain your “toasted” content and strongly encourage a dismiss
                            button.</p>
                        <div class="toast fade show bg-primary text-white border-0" role="alert" aria-live="assertive"
                            aria-atomic="true">
                            <div class="toast-header bg-primary text-white">
                                ...
                                <small>11 mins ago</small>
                                <button type="button" class="ms-2 mb-1 btn-close btn-close-white text-white"
                        ...
                        <div class="toast fade show bg-success text-white border-0 mt-3" role="alert"
