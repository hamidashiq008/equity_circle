                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <p>The base <code>.nav</code> component does not include any <code>.active</code> state. The
                            following examples include the class, mainly to demonstrate that this particular class does
                            not trigger any special styling.</p>
                        <ul class="nav nav-tabs" id="myTab-1" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#profile-one" role="tab"
                        ...
                        <div class="tab-content" id="myTabContent-2">
                            ...
                            <div class="tab-pane fade" id="profile-one" role="tabpanel" aria-labelledby="profile-tab">
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                                    Ipsum has been the industry's standard dummy text ever since the 1500s, when an
                                    unknown printer took a galley of type and scrambled it to make a type specimen book.
                                </p>
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <ul class="nav nav-tabs" id="myTab-two" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab-two" data-bs-toggle="tab" href="#profile-two"
                                    role="tab" aria-controls="profile" aria-selected="false">Profile</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="contact-tab-two" data-bs-toggle="tab" href="#contact-two"
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <ul class="nav nav-tabs justify-content-center" id="myTab-2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="home-tab-justify" data-bs-toggle="tab"
                                    href="#home-justify" role="tab" aria-controls="home" aria-selected="true">Home</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab-justify" data-bs-toggle="tab"
                                    href="#profile-justify" role="tab" aria-controls="profile"
                                    aria-selected="false">Profile</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="contact-tab-justify" data-bs-toggle="tab"
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <p>Force your <code>.nav</code>’s contents to extend the full available width one of two
                            ...
                            <code>.nav-item</code>s, use <code>.nav-fill</code>. Notice that all horizontal space is
                            occupied, but not every nav item has the same width.</p>
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <ul class="nav nav-tabs justify-content-end" id="myTab-4" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab-end" data-bs-toggle="tab" href="#profile-end"
                                    role="tab" aria-controls="profile" aria-selected="false">Profile</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="contact-tab-end" data-bs-toggle="tab" href="#contact-end"
                                    role="tab" aria-controls="contact" aria-selected="false">Contact</a>
                            </li>
                        </ul>
