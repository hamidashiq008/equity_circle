        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <p><code>.h1</code> through <code>.h6</code> classes are also available, for when you want to
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <dl class="row">
                            ...
                            <dd class="col-sm-9 mx-0">A description list is perfect for defining terms.</dd>
                            <dt class="col-sm-3">Euismod</dt>
                            <dd class="col-sm-9 mx-0">
                                <p class="mb-0">Vestibulum id ligula porta felis euismod semper eget lacinia odio sem
                                    nec elit.</p>
                                <p class="mb-0">Donec id elit non mi porta gravida at eget metus.</p>
                            </dd>
                            <dt class="col-sm-3">Malesuada porta</dt>
                            <dd class="col-sm-9 mx-0">Etiam porta sem malesuada magna mollis euismod.</dd>
                            <dt class="col-sm-3 text-truncate">Truncated term is truncated</dt>
                            <dd class="col-sm-9 mx-0">Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum
                                nibh, ut fermentum massa justo sit amet risus.</dd>
                            <dt class="col-sm-3">Nesting</dt>
                            <dd class="col-sm-9 mx-0">
                                <dl class="row">
                                    <dt class="col-sm-4">Nested definition list</dt>
                                    <dd class="col-sm-8 mx-0">Aenean posuere, tortor sed cursus feugiat, nunc augue
                                        blandit nunc.</dd>
                                </dl>
                            </dd>
                        </dl>
