...
Route::group(['prefix' => 'store'], function () {
  ...
  Route::get('productdetail', [HomeController::class, 'productdetail'])->name('store.productdetail');
...
Route::group(['prefix' => 'ui'], function () {
  ...
  Route::get('uioffcanvas', [HomeController::class, 'uioffcanvas'])->name('ui.uioffcanvas');
});
